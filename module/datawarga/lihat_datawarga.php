...
$(document).ready(function(){
  ...
  $("#propinsi").change(function(){
    ...
    $.ajax({
        url: "module/datawarga/ambilkota.php",
  ...
  $("#kota").change(function(){
    var kota = $("#kota").val();
    $.ajax({
        url: "module/datawarga/ambilkecamatan.php",
        data: "kota="+kota,
        cache: false,
        success: function(msg){
            $("#kecamatan").html(msg);
  ...
  $("#kecamatan").change(function(){
    ...
    $.ajax({
        url: "module/datawarga/ambilkelurahan.php",
  ...
  $("#kelurahan").change(function(){
    ...
    $.ajax({
        url: "module/datawarga/ambilkodepos.php",
...
?>
   ...
   <form method="POST" class="form-horizontal" enctype="multipart/form-data" action="<?php echo $aksi;?>?module=datawarga" id="popup-validation">
                  ...
                  <div class="box-body">
				   ...
				   <div class="form-group">
					...
					<div class="form-group">	
					  ...
					  <div class="col-sm-6">
                       <select class='validate[required] form-control select2' name='nama_lingkungan' readonly>
					  ...
					  <div class="col-sm-6">
                       <select class='validate[required] form-control select2' name='dasawisma' readonly>
					...
					<div class="form-group">
                      ...
                      <div class="col-sm-5">
                        <input type="text" class="validate[required,custom[number]] form-control" readonly name="noreg" placeholder="No.ID" value="<?php echo $r['noreg'];?>" readonly>
                      </div>
					</div>
					  ...
					  <div class="col-sm-6">
                       <select class='validate[required] form-control select2' name='kriteria' readonly>
					 ...
					 <div class="form-group">	
					  ...
					  <div class="col-sm-7">
                       <select class='validate[required] form-control select2' name='jabpkk' id='jabpkk' readonly>
					...
					<div class="form-group">
					 <label for="jenkel" class="col-sm-4 control-label">Jenis Kelamin<span class="text-danger"> *</span></label>
					  <div class="col-sm-4">
                        <select class=" validate[required] form-control" name='jenkel' readonly>
					 ...
					 <label for="stskawin" class="col-sm-4 control-label">Status Perkawinan</label>
					  <div class="col-sm-5">
                        <select class="validate[required] form-control" name='stskawin' readonly>
				   ...
				   <div class="form-group">	
					  ...
					  <div class="col-sm-7">
                       <select class='validate[required] form-control select2' name='stskel' readonly>
					 ...
					 <label for="agama" class="col-sm-4 control-label">Agama<span class="text-danger"> *</span></label>
					  <div class="col-sm-5">
                        <select class=" validate[required] form-control" name='agama' id='agama' readonly>
				    ...
				    <div class="form-group">
					  <label for="alamat_domisili" class="col-sm-4 control-label">Alamat<span class="text-danger"> *</span></label>
					  <div class="col-sm-7">
                        <textarea type="text" class="validate[required] form-control" name="alamat_domisili" placeholder="Alamat Domisili" readonly><?php echo $r['alamat_domisili'];?></textarea>
                       </div>
					 </div>
					 <div class="form-group">
					 ...
					 <div class="form-group">	
					  ...
					  <div class="col-sm-6">
                       <select class='validate[required] form-control select2' name='pendidikan' readonly>
					  ...
					  <div class="col-sm-7">
                       <select class='validate[required] form-control select2' name='pekerjaan' id='pekerjaan' readonly>
					...
					<div class="form-group">
					 <label for="stsaktif" class="col-sm-4 control-label">Status Aktif<span class="text-danger"> *</span></label>
					  <div class="col-sm-4">
                        <select class=" validate[required] form-control" name='stsaktif' readonly>
					 ...
					 <label for="akseptorkb" class="col-sm-4 control-label">Akseptor KB<span class="text-danger"> *</span></label>
					  <div class="col-sm-4">
                        <select class=" validate[required] form-control" name='akseptorkb' readonly>
					...
					<div class="form-group">	
					  ...
					  <div class="col-sm-7">
                       <select class='form-control select2' name='jenisakseptor' readonly>
					...
					<div class="form-group">
					 <label for="aktif_posyandu" class="col-sm-4 control-label">Aktif Kegiatan Posyandu<span class="text-danger"> *</span></label>
					  <div class="col-sm-4">
                        <select class=" validate[required] form-control" name='aktif_posyandu' readonly>
					...
					<div class="form-group">
					  ...
					  <div class="col-sm-3">
                        <input type="text" class="form-control" name="frekuensi" placeholder="Frekuensi/Bulan" value="<?php echo $r['frekuensi'];?>" readonly>
                       </div>
					 </div>
					 ...
					 <label for="bkb" class="col-sm-4 control-label">Mengikuti Program BKB<span class="text-danger"> *</span></label>
					  <div class="col-sm-4">
                        <select class=" validate[required] form-control" name='bkb' readonly>
					 ...
					 <label for="tabungan" class="col-sm-4 control-label">Memiliki Tabungan<span class="text-danger"> *</span></label>
					  <div class="col-sm-4">
                        <select class=" validate[required] form-control" name='tabungan' readonly>
					 ...
					 <label for="kelbelajar" class="col-sm-4 control-label">Mengikuti Kelompok Belajar<span class="text-danger"> *</span></label>
					  <div class="col-sm-4">
                        <select class=" validate[required] form-control" name='kelbelajar' readonly>
					 ...
					 <label for="paud" class="col-sm-4 control-label">Mengikuti PAUD/Sejenis<span class="text-danger"> *</span></label>
					  <div class="col-sm-4">
                        <select class="validate[required] form-control" name='paud' readonly>
					 ...
					 <label for="koperasi" class="col-sm-4 control-label">Ikut Kegiatan Koperasi PKK<span class="text-danger"> *</span></label>
					  <div class="col-sm-4">
                        <select class=" validate[required] form-control" name='koperasi' readonly>
		...
		<div class="col-sm-offset-2 col-sm-5">
         ...
         <a class="btn btn-danger"  title="Kembali"  href="?module=datawarga"><i class="fa fa-remove"></i>
                    Kembali
                </a>
            </div>
       </div>
