...
?>
     <center><h3 class="box-title">Edit Data Satuan Industri Rumah Tangga</h3></center>
   ...
   <form method="POST" class="form-horizontal" enctype="multipart/form-data" action="<?php echo $aksi;?>?module=satuan&act=update&id=<?php echo $id;?>" id="popup-validation">
	<?php
				...
				<div class="col-md-6">
					<div class="box-body">
					 ...
					 <div class="form-group">
					  ...
					  <div class="col-sm-7">
                        <input type="text" class="validate[required] form-control" name="namasatuan" value="<?php echo $r['satuan'];?>" placeholder="Nama Satuan">
                       </div>
					 </div>
