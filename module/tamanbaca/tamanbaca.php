			...
			?>
				...
				<div class='box-body'>
					<div style="text-align:right">
						...
						<a  class="btn bg-blue margin" data-toggle="tooltip" data-placement="top" title="Print Laporan" href="?module=laptamanbaca" target="_blank"><i class="fa fa-print"></i> Print Laporan</a>
						<a class="btn bg-purple margin" href="?module=tamanbaca&act=tambahtamanbaca"><i class="fa fa-plus"></i> Tambah</a>
					</div>
