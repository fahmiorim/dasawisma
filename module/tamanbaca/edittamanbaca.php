...
if(!isset($_GET['id']) || $_GET['id'] == "")
{
    ...
    <script>
       ...
       window.location.href = 'appmaster.php?module=tamanbaca';
    </script>
    <?php
}
$id = $_GET['id'];
...
?>
     <center><h3 class="box-title">EDIT DATA TAMAN BACAAN PKK</h3></center>
   ...
   <form method="POST" class="form-horizontal" enctype="multipart/form-data" action="<?php echo $aksi;?>?module=tamanbaca&act=update"id="popup-validation">
	<?php
		$res=pg_query($koneksi, "select * from tamanbaca where id=".$id);
	...
	?>
        <input type="hidden" name="id" value="<?php echo $r['id'];?>" />
				<div class="col-md-6">
                   ...
                   <div class="form-group">
					  ...
					  <div class="col-sm-8">
                        <input type="text" class="validate[required] form-control" name="namatamanbaca" placeholder="Nama Taman Bacaan" value="<?php echo $r[namatamanbaca];?>">
                       </div>
					 </div>
				...
				<div class="col-md-6">
					...
					<label for="jlhbuku" class="col-sm-4 control-label">Jumlah Buku<span class="text-danger"> *</span></label>
					  <div class="col-sm-3">
					    <input type="text" class="validate[required,custom[number]] form-control" name="jlhbuku" id="jlhbuku" placeholder="Jumlah Buku" value="<?php echo $r[jlhbuku];?>">
                     </div>
					 </div>
        ...
        <div class="form-group">
               <div class="col-sm-offset-2 col-sm-5">
                <button class="btn bg-purple btn-flat margin"  name="cmdedittamanbaca" title="Edit" ><i class="fa fa-pencil"></i>
                   Edit
                </button>
