...
?>
     <center><h3 class="box-title">LIHAT DATA TAMAN BACAAN PKK</h3></center>
   ...
   <form method="POST" class="form-horizontal" enctype="multipart/form-data" action="<?php echo $aksi;?>?module=tamanbaca"id="popup-validation">
	<?php
