...
// Apabila user sudah login dengan benar, maka terbentuklah session
	...
	// Input Data KRT
	if ($module == 'datakrt' and $act == 'input') {
 
		$ceknokrt = $_POST[nokrt];
	...
	$query = pg_query($koneksi, "SELECT * FROM datakrt WHERE namakrt='$ceknokrt'"); 
   ...
   if($cek > 0){
	...
	?>
	   ...
	   <script>
        alert('No KRT sudah terdatar, silahkan input ulang');
...
?>
	...
	// Update datakrt
	elseif ($module == 'datakrt' and $act == 'update') {
