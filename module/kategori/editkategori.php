...
?>
     <center><h3 class="box-title">Edit Data Kategori Pekarangan</h3></center>
   ...
   <form method="POST" class="form-horizontal" enctype="multipart/form-data" action="<?php echo $aksi;?>?module=kategori&act=update&id=<?php echo $id;?>" id="popup-validation">
	<?php
				...
				<div class="col-md-6">
					<div class="box-body">
					 ...
					 <div class="form-group">
					  ...
					  <div class="col-sm-7">
                        <input type="text" class="validate[required] form-control" name="namakategori" value="<?php echo $r['kategori'];?>" placeholder="Nama Kategori">
                       </div>
					 </div>
