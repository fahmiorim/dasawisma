...
?>
   ...
   <form method="POST" class="form-horizontal" enctype="multipart/form-data" action="<?php echo $aksi;?>?module=resetpassword&act=update&id=<?php echo $id; ?>">
	<?php
        ...
        <div class="col-md-6">
                ...
                <div class="box-body">
					...
					<div class="btn btn-default btn-file">
                        ...
                        <img id="preview_gambar" style="width: 125px; height: 145px" src="assets/images/foto_user/blank.png" >

						<?php } else { ?>
						<input type="file"  name="fupload" onchange="readURL5(this);" />
                        <img id="preview_gambar5" style="width: 125px; height: 145px" src="assets/img/foto_user/<?php echo $r['foto'];?>" >
						<?php } ?>   
