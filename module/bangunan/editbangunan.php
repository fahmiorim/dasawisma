...
?>
			...
			?>
			<center>
				<h3 class="box-title">EDIT DATA BANGUNAN PKK</h3>
			</center>
			...
			<div class="box box-info">
				...
				<form method="POST" class="form-horizontal" enctype="multipart/form-data" action="<?php echo $aksi; ?>?module=bangunan&act=update" id="popup-validation">
					<?php
					$res = pg_query($koneksi, "select * from bangunan where id=" . $id);
						...
						<div class="col-md-6">
							<div class="box-body">
								...
								<div class="form-group">
									...
									<div class="col-sm-8">
										<input type="text" class="validate[required] form-control" name="nama_bangunan" placeholder="Nama Bangunan" value="<?php echo $r[nama_bangunan]; ?>">
									</div>
								</div>
					...
					<div class="form-group">
						<div class="col-sm-offset-2 col-sm-5">
							<button class="btn bg-purple btn-flat margin" name="cmdeditbangunan" title="Edit"><i class="fa fa-pencil"></i>
								Edit
							</button>
