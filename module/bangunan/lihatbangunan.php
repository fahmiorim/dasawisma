...
?>
			...
			?>
			<center>
				<h3 class="box-title">LIHAT DATA BANGUNAN PKK</h3>
			</center>
			...
			<div class="box box-info">
				...
				<form method="POST" class="form-horizontal" enctype="multipart/form-data" action="<?php echo $aksi; ?>?module=bangunan" id="popup-validation">
					<?php
						...
						<div class="col-md-6">
							<div class="box-body">
								...
								<div class="form-group">
									...
									<div class="col-sm-8">
										<input type="text" class="validate[required] form-control" name="nama_bangunan" placeholder="Nama Bangunan" value="<?php echo $r[nama_bangunan]; ?>" readonly>
									</div>
								</div>
