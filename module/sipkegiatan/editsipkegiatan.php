...
?>
   ...
   <form method="POST" class="form-horizontal" enctype="multipart/form-data" name="sipkegiatan" action="<?php echo $aksi;?>?module=sipkegiatan&act=update&id=<?php echo $id;?>" id="popup-validation">
	<?php
