  ...
  $count=pg_num_rows($dtwarga);
	...
	<div class='box'>
                <div class='box-header'>
                  <h2 class='box-title'>LAPORAN CATATAN KELUARGA KECAMATAN $namakec</h2>";
		...
		<?php } ?>	
				...
				<div class="box-body table-responsive no-padding">
                  <table id='example1' class='table table-bordered table-striped'>
							<script type="text/javascript">
								...
								function popup() {
								window.open('modul/catkeluargakec/lap_catkeluarga.php?nokrt=<?php echo $datanokrt;?>')
								}
							</script>
							...
							<script type="text/javascript">
								var s5_taf_parent = window.location;
								function popup2() {
								window.open('modul/catkeluargakec/lap_catkeluarga2.php?nokrt=<?php echo $datanokrt;?>')
								}
							</script>
				<div class="form-group">
					 ...
					 <label for="nama_dasawisma" class="col-sm-1 control-label">Dasawisma</label>
					  <div class="col-sm-3">
                        <input type="text" class="validate[required] form-control"  name="nama_dasawisma" id="nama_dasawisma" placeholder="Nama Dasawisma" value="<?php echo "$datanama_dasawisma";?>"readonly>
								...
								<div style="text-align:right">	
								 <a  class="btn bg-green margin"  data-toggle="tooltip" data-placement="top" title="Catatan Keluarga" href="?module=catkeluargakec"><i class="fa fa-send"></i>Catatan Keluarga</a>
					...
					$tim =pg_query($koneksi, "select * from datawarga where nokrt='$datanokrt' and kodekec='$_SESSION[ses_kodekec]' order by id ");
