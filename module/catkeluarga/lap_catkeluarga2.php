...
$datanokrt=$_GET[nokrt];
	$datanamakrt=$_GET[namakrt];
...
<input type="hidden" name="id" value="<?php echo $r['id'];?>" />
  ...
  <tr>
    <td colspan="7" align="center"><div align="right" class="style3">Lampiran III - 15 </div></td>
  </tr>
  <tr>
  ...
  <tr>
    <td align="center"><div align="justify"><span class="style4">NO.KEPALA RUMAH TANGGA </span></div></td>
    <td align="center">:</td>
    <td width="345" align="center"><div align="justify"><span class="style4"><?php echo "$_GET[nokrt]";?></span></div></td>
    <td width="889" align="center">&nbsp;</td>
    <td align="center"><div align="justify"><span class="style5">KRITERIA RUMAH </span></div></td>
    <td align="center"><span class="style4">:</span></td>
    <td align="center" class="style5"><div align="justify">Rumah Sehat / Kurang Sehat </div></td>
  </tr>
  <tr>
    <td align="center"><div align="justify"><span class="style4">CATATAN KELUARGA DARI </span></div></td>
    <td align="center"><span class="style4">:</span></td>
    <td align="center"><div align="justify" class="style4"><span class="style4"><?php echo" $nok[namakrt]"; ?></span></div></td>
    <td align="center">&nbsp;</td>
    <td align="center"><div align="justify"><span class="style5">JAMBAN KELUARGA </span></div></td>
    <td align="center">:</td>
    <td align="center"><div align="justify"><span class="style5">Ada / Tidak Jumlah : .... buah </span></div></td>
  </tr>
  <tr>
    <td align="center"><div align="justify"><span class="style4">ANGGOTA KELOMPOK DASAWISMA </span></div></td>
    <td align="center"><span class="style4">:</span></td>
    <td align="center"><div align="justify"><span class="style4"><?php echo" $nok[nama_dasawisma]"; ?></span></div></td>
    <td align="center">&nbsp;</td>
    <td align="center"><div align="justify"><span class="style5">SUMBER AIR </span></div></td>
    <td align="center">:</td>
    <td align="center"><div align="justify"><span class="style5">PDAM/ Sumur/ Lainnya</span></div></td>
  </tr>
  <tr>
    <td width="227" align="center"><div align="justify" class="style4">TAHUN</div></td>
    <td width="5" align="center"><span class="style4">:</span></td>
    <td align="center"><div align="justify"><span class="style4"><?php echo "$thn_sekarang";?></span></div></td>
    <td align="center">&nbsp;</td>
    <td width="121" align="center"><div align="justify"><span class="style5">TEMPAT SAMPAH  </span></div></td>
    <td width="9" align="center">:</td>
    <td width="142" align="center"><div align="justify"><span class="style5">Ada/ Tidak </span></div></td>
  </tr>
  <tr>
  ...
  <tr>
    <td colspan="7"><table width="1762" border="1" cellpadding="0" cellspacing="0" class="table table-bordered table-striped">
      <tr>
      ...
      <tr>
						<td><div align="center"><span class="style4"><?php echo" $no"; ?></span></div></td>
						...
						<td><span class="style4"><?php echo" $tm[tgldaftar]"; ?></span></td>
