...
?>
			...
			?>
			<center>
				<h3 class="box-title">LIHAT DATA MESIN PKK</h3>
			</center>
			...
			<div class="box box-info">
				...
				<form method="POST" class="form-horizontal" enctype="multipart/form-data" action="<?php echo $aksi; ?>?module=mesin" id="popup-validation">
					<?php
						...
						<div class="col-md-6">
							<div class="box-body">
								...
								<div class="form-group">
									...
									<div class="col-sm-8">
										<input type="text" class="validate[required] form-control" name="nama_mesin" placeholder="Nama Mesin/Elektronik" value="<?php echo $r[nama_mesin]; ?>" readonly>
									</div>
								</div>
								...
								<div class="form-group">
									...
									<div class="col-sm-7">
										<input type="text" class="validate[required] form-control" name="penerima" id="penerima" placeholder="Penerima" value="<?php echo $r[penerima]; ?>" readonly>
									</div>
								</div>
