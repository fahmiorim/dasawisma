...
?>
			...
			?>
			<center>
				<h3 class="box-title">EDIT DATA MESIN PKK</h3>
			</center>
			...
			<div class="box box-info">
				...
				<form method="POST" class="form-horizontal" enctype="multipart/form-data" action="<?php echo $aksi; ?>?module=mesin&act=update" id="popup-validation">
					<?php
					$res = pg_query($koneksi, "select * from mesin where id=" . $id);
					...
					?>
						...
						<div class="col-md-6">
							<div class="box-body">
								...
								<div class="form-group">
									<label for="nama_mesin" class="col-sm-4 control-label">Nama Mesin/Elektronik<span class="text-danger"> *</span></label>
									<div class="col-sm-8">
										<input type="text" class="validate[required] form-control" name="nama_mesin" placeholder="Nama Mesin/Elektronik" value="<?php echo $r[nama_mesin]; ?>">
									</div>
								</div>
								...
								<div class="form-group">
									...
									<div class="col-sm-7">
										<input type="text" class="validate[required] form-control" name="penerima" id="penerima" placeholder="Penerima" value="<?php echo $r[penerima]; ?>">
									</div>
								</div>
					...
					<div class="form-group">
						<div class="col-sm-offset-2 col-sm-5">
							<button class="btn bg-purple btn-flat margin" name="cmdeditmesin" title="Edit"><i class="fa fa-pencil"></i>
								Edit
							</button>
