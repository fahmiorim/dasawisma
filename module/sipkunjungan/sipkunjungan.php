  ...
  switch($act){
    default:
		...
		<div class='box-body'>
          ...
          <a  class="btn bg-blue margin" data-toggle="tooltip" data-placement="top" title="Print Laporan" href="?module=lapsipkunjungan" target="_blank"><i class="fa fa-print"></i> Print Laporan</a>
