...
if (empty($_SESSION['ses_user']) AND empty($_SESSION['ses_password'])){
 header('location:../../../404.php');
	...
	$aksi = "module/lingkungan/aksi_lingkungan.php";
...
?>
     <center><h3 class="box-title">Edit Data lingkungan Kabupaten Batu Bara</h3></center>
   ...
   <form method="POST" class="form-horizontal" enctype="multipart/form-data" action="<?php echo $aksi;?>?module=lingkungan&act=update&id=<?php echo $id;?>" id="popup-validation">
	<?php
		$res=pg_query($koneksi, "select * from lingkungan where id=".$id);
				...
				<div class="col-md-6">
					...
					<div class="form-group">
					 ...
					 <div class="form-group">
					  ...
					  <div class="col-sm-7">
                        <input type="text" class="validate[required] form-control" name="nama_lingkungan" value="<?php echo $r['nama_lingkungan'];?>" placeholder="Nama Lingkungan">
                       </div>
					 </div>
