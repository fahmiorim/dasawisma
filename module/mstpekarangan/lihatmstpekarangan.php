...
?>
     <center><h3 class="box-title">Lihat Data Pemanfaatan Pekarangan</h3></center>
   ...
   <form method="POST" class="form-horizontal" enctype="multipart/form-data" action="<?php echo $aksi;?>?module=mstpekarangan&id=<?php echo $id;?>" id="popup-validation">
	<?php
