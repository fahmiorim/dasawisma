...
?>
     <center><h3 class="box-title">Lihat Data Kriteria Kota Binjai</h3></center>
   ...
   <form method="POST" class="form-horizontal" enctype="multipart/form-data" action="<?php echo $aksi;?>?module=kriteria&id=<?php echo $id;?>" id="popup-validation">
	<?php
				...
				<div class="col-md-6">
					...
					<div class="form-group">
					 ...
					 <div class="form-group">
					  ...
					  <div class="col-sm-7">
                        <input type="text" class="validate[required] form-control" name="nama_kriteria" value="<?php echo $r['nama_kriteria'];?>" placeholder="Nama Kriteria" readonly>
                       </div>
					 </div>
