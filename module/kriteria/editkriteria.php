...
?>
     <center><h3 class="box-title">Edit Data Kriteria Kota Binjai</h3></center>
   ...
   <form method="POST" class="form-horizontal" enctype="multipart/form-data" action="<?php echo $aksi;?>?module=kriteria&act=update&id=<?php echo $id;?>" id="popup-validation">
	<?php
		$res=pg_query($koneksi, "select * from kriteria where id=".$id);
				...
				<div class="col-md-6">
					...
					<div class="form-group">
					 ...
					 <div class="form-group">
					  ...
					  <div class="col-sm-8">
                        <input type="text" class="validate[required] form-control" name="nama_kriteria" value="<?php echo $r['nama_kriteria'];?>" placeholder="Nama Kriteria">
                       </div
