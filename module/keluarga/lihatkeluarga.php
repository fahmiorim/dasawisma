...
?>
			...
			?>
			<center>
				<h3 class="box-title">Lihat Data Keluarga PKK Kabupaten Batu Bara</h3>
			</center>
			...
			<div class="box box-info">
				...
				<form method="POST" class="form-horizontal" enctype="multipart/form-data" action="<?php echo $aksi; ?>?module=keluarga" id="popup-validation">
					<?php
							...
							<div class="box-body">
								...
								<div class="form-group">
									...
									<div class="col-sm-5">
										...
										<input type="text" class="validate[required,custom[number]] form-control" name="noreg" id="noreg" placeholder="No.ID" value="<?php echo $r[noreg]; ?>" readonly>
									</div>
								</div>
					  ...
					  <div class="col-sm-3">
					    <input type="text" class="validate[required,custom[number]] form-control" name="balita" id="balita" value="<?php echo $r[balita]; ?>" placeholder="Jumlah Balita"readonly>
								...
								<div class="form-group">
									...
									<div class="col-sm-3">
										<input type="text" class="validate[required,custom[number]] form-control" name="balitapr" id="balitapr" placeholder="Laki-Laki" value="<?php echo $r[balitapr]; ?>" readonly>
									</div>
								</div>
								...
								<div class="form-group">
									...
									<div class="col-sm-3">
										<input type="text" class="validate[required,custom[number]] form-control" name="balitaw" id="balitaw" placeholder="Perempuan" value="<?php echo $r[balitaw]; ?>" readonly>
									</div>
								</div>
								...
								<div class="form-group">
									...
									<div class="col-sm-3">
										<input type="text" class="validate[required,custom[number]] form-control" name="ibum" id="ibum" value="<?php echo $r[ibumenyusui]; ?>" placeholder="Ibu Menyusui" readonly>
									</div>
								</div>
					  ...
					  <div class="col-sm-7">
						...
						<div class="col-md-6">
							<div class="box-body">
								...
								<div class="form-group">
									<label for="up2k" class="col-sm-4 control-label">Aktifitas UP2K</label>
									<div class="col-sm-4">
										<select class="form-control" name='up2k' readonly>
								...
								<div class="form-group">
									<label for="jenis_usaha" class="col-sm-4 control-label">Jenis Usaha UP2K</label>
									<div class="col-sm-6">
										<select class='select2 form-control' name='jenis_usaha' id='jenis_usaha' disabled>
								...
								<div class="form-group">
									<label for="pekarangan" class="col-sm-4 control-label">Pemanfaatan Pekarangan</label>
									<div class="col-sm-4">
										<select class="form-control" name='pekarangan' readonly>
								...
								<div class="form-group">
									<label for="komoditi_lahan" class="col-sm-4 control-label">Komoditi Pekarangan</label>
									<div class="col-sm-6">
										<select class='select2 form-control' name='komoditi_lahan' id='komoditi_lahan' disabled>
								...
								<div class="form-group">
									...
									<div class="col-sm-6">
										<select class='select2 form-control' name='komoditi_industri' id='komoditi_industri' disabled>
								...
								<div class="form-group">
									<label for="nama_komoditi" class="col-sm-4 control-label">Nama Komoditi</label>
									<div class="col-sm-8">
										<input type="text" class="form-control" id="nama_komoditi" name="nama_komoditi" placeholder="Nama Komoditi" value="<?php echo $r[nama_komoditi_industri]; ?>" readonly>
									</div>
								</div>
