...
?>
     <center><h3 class="box-title">EDIT DATA DETEKSI DINI KANKER LEHER RAHIM DAN KANKER PAYUDARA</h3></center>
   ...
   <form method="POST" class="form-horizontal" enctype="multipart/form-data" action="<?php echo $aksi;?>?module=rekapiva&act=update&id=<?php echo $id;?>" id="popup-validation">
	<?php
	...
	?>	
        <input type="hidden" name="id" value="<?php echo $r['id'];?>" />
				<div class="col-md-6">
				  ...
				  <div class="form-group">
					...
					<label for="diperiksa" class="col-sm-4 control-label">Diperiksa<span class="text-danger"> *</span></label>
					  <div class="col-sm-3">
					    <input type="text" class="validate[required,custom[number]] form-control" name="diperiksa" value="<?php echo $r[diperiksa];?>"placeholder="Diperiksa">
                     </div>
					 </div>
					...
					<label for="normal" class="col-sm-4 control-label">Normal<span class="text-danger"> *</span></label>
					  <div class="col-sm-3">
					    <input type="text" class="validate[required,custom[number]] form-control" name="normal" value="<?php echo $r[normal];?>" placeholder="Normal">
                     </div>
					 </div>
					...
					<label for="tumor" class="col-sm-4 control-label">Tumor/Benjolan<span class="text-danger"> *</span></label>
					  <div class="col-sm-3">
					    <input type="text" class="validate[required,custom[number]] form-control" name="tumor" value="<?php echo $r[tumor];?>" placeholder="Tumor/Benjolan">
                     </div>
					 </div>
					...
					<label for="curigapayudara" class="col-sm-4 control-label">Curiga Kanker Payudara<span class="text-danger"> *</span></label>
					  <div class="col-sm-3">
					    <input type="text" class="validate[required,custom[number]] form-control" name="curigapayudara" value="<?php echo $r[curigapayudara];?>" placeholder="Curiga Kanker Payudara">
                     </div>
					 </div>
					...
					<label for="payudara" class="col-sm-4 control-label">Kanker Payudara<span class="text-danger"> *</span></label>
					  <div class="col-sm-3">
					    <input type="text" class="validate[required,custom[number]] form-control" name="payudara" value="<?php echo $r[payudara];?>"placeholder="Kanker Payudara">
                     </div>
					 </div>
				...
				<div class="col-md-6">
					...
					<label for="ivanegatif" class="col-sm-4 control-label">IVA Negatif<span class="text-danger"> *</span></label>
					  <div class="col-sm-3">
					    <input type="text" class="validate[required,custom[number]] form-control" name="ivanegatif" value="<?php echo $r[ivanegatif];?>" placeholder="IVA Negatif">
                     </div>
					 </div>
					...
					<label for="ivapositif" class="col-sm-4 control-label">IVA Positif<span class="text-danger"> *</span></label>
					  <div class="col-sm-3">
					    <input type="text" class="validate[required,custom[number]] form-control" name="ivapositif" value="<?php echo $r[ivapositif];?>" placeholder="IVA Positif">
                     </div>
					 </div>
					...
					<label for="curigaiva" class="col-sm-4 control-label">Curiga Kanker IVA<span class="text-danger"> *</span></label>
					  <div class="col-sm-3">
					    <input type="text" class="validate[required,custom[number]] form-control" name="curigaiva" value="<?php echo $r[curigaiva];?>" placeholder="Curiga Kanker IVA">
                     </div>
					 </div>
					...
					<label for="kelainan" class="col-sm-4 control-label">Kelainan Lainnya<span class="text-danger"> *</span></label>
					  <div class="col-sm-3">
					    <input type="text" class="validate[required,custom[number]] form-control" name="kelainan" value="<?php echo $r[kelainan];?>" placeholder="Kelainan Lainnya">
                     </div>
					 </div>
					...
					<label for="rahim" class="col-sm-4 control-label">Kanker Leher Rahim<span class="text-danger">*</span></label>
					  <div class="col-sm-3">
					    <input type="text" class="validate[required,custom[number]] form-control" name="rahim" value="<?php echo $r[rahim];?>" placeholder="Kanker Leher Rahim">
                     </div>
					 </div>
					...
					<label for="kriosama" class="col-sm-4 control-label">Hari yang sama<span class="text-danger">*</span></label>
					  <div class="col-sm-3">
					    <input type="text" class="validate[required,custom[number]] form-control" name="kriosama" value="<?php echo $r[kriosama];?>" placeholder="Hari yang sama">
                     </div>
					 </div>
					...
					<label for="kriobeda" class="col-sm-4 control-label">Hari yang berbeda<span class="text-danger">*</span></label>
					  <div class="col-sm-3">
					    <input type="text" class="validate[required,custom[number]] form-control" name="kriobeda" value="<?php echo $r[kriobeda];?>" placeholder="Hari yang berbeda">
                     </div>
					 </div>
        ...
        <div class="form-group">
               <div class="col-sm-offset-2 col-sm-5">
                <button class="btn bg-purple btn-flat margin"  name="cmdeditrekapiva" title="Edit" ><i class="fa fa-pencil"></i>
                   Edit
                </button>
