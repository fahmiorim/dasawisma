...
?>
     <center><h3 class="box-title">Edit Data Keluarga PKK Kabupaten Batu Bara</h3></center>
   ...
   <form method="POST" class="form-horizontal" enctype="multipart/form-data" name="keluarga" action="<?php echo $aksi;?>?module=keluarga2&act=update"id="popup-validation">
	<?php
				...
				<div class="col-md-6">
					...
					<label for="nokk" class="col-sm-4 control-label">No.KK<span class="text-danger"> *</span></label>
					  ...
					  <input type="hidden"  id="id" class="form-control" />
                        <input type="text" class="validate[required,custom[number]] form-control" name="nokk" value="<?php echo $r[nokk];?>" placeholder="No.KK">
                     </div>
					 </div>
					...
					<div class="form-group">
					  ...
					  <div class="col-sm-7">
                        <input type="text" class="validate[required] form-control" name="nokrt" id="nokrt" value="<?php echo $r[nokrt];?>" placeholder=" No.KRT" readonly>
                       </div>
					 </div>
