...
?>
     <center><h3 class="box-title">Lihat Data Keluarga PKK Kabupaten Batu Bara</h3></center>
   ...
   <form method="POST" class="form-horizontal" enctype="multipart/form-data" action="<?php echo $aksi;?>?module=keluarga2"id="popup-validation">
	<?php
        ...
        <input type="hidden" name="id" value="<?php echo $r['id'];?>" />
				<div class="col-md-6">
					...
					<div class="form-group">
					  ...
					  <div class="col-sm-7">
                        <input type="text" class="validate[required] form-control" name="nokrt" id="nokrt" value="<?php echo $r[nokrt];?>" placeholder=" No.KRT" value="<?php echo $r[nokrt];?>" readonly>
                       </div>
					 </div>
					...
					<label for="balita" class="col-sm-4 control-label">Jumlah Balita<span class="text-danger"> *</span></label>
					  <div class="col-sm-3">
					    <input type="text" class="validate[required,custom[number]] form-control" name="balita" id="balita" value="<?php echo $r[balita];?>" placeholder="Jumlah Balita">
                     </div>
					 </div>
