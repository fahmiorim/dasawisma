<script type="text/javascript">
    $(function() {
        ...
        $(document).on('click', '.pilih8', function() {
            ...
            console.log('Kelurahan selected - kodekel:', kodekel, 'nama_kel:', nama_kel);
...
if (empty($_SESSION['ses_user']) AND empty($_SESSION['ses_password'])){  
  header('location:404.php');
	...
	$aksi = "modul/tamanbaca2/aksi_tamanbaca2.php";
  ...
  $kec = pg_query($koneksi, "SELECT * FROM tamanbaca order by namatamanbaca LIMIT $limit OFFSET $offset");
	echo"
          ...
          <a  class="btn bg-purple margin" data-toggle="tooltip" data-placement="top" title="Tambah" href="?module=tamanbaca2&act=tambahtamanbaca2"><i class="fa fa-send"></i> Tambah</a> 
		  
		<?php
		if($count > 0)
        {
		?>			 
			 <button class="btn bg-orange btn-flat margin"  data-toggle="tooltip" data-placement="top" title="lihat"  onClick="view_records_tamanbaca2();" ><i class="fa fa-desktop"></i> Lihat</button>
		  <button class="btn bg-olive btn-flat margin" data-toggle="tooltip" data-placement="top" title="Edit"  onClick="update_records_tamanbaca2();" ><i class="fa fa-edit"></i> Edit</button> 
		  <button class="btn btn-danger" data-toggle="tooltip" data-placement="top" title="Hapus"   onClick="delete_records_tamanbaca2();" ><i class="fa fa-remove"></i> Hapus </button>
		  </div>
			...
			?>
              ...
              ?> 
                ...
                <div class='box-footer'>
                  <ul class='pagination'>
                    <?php if($page > 1): ?>
                      <li><a href='?module=tamanbaca2&page=<?php echo $page - 1; ?>'>&laquo; Prev</a></li>
                    <?php endif; ?>

                    <?php for($i = 1; $i <= $total_pages; $i++): ?>
                      <li class='<?php echo $i == $page ? 'active' : ''; ?>'>
                        <a href='?module=tamanbaca2&page=<?php echo $i; ?>'><?php echo $i; ?></a>
                      </li>
                    <?php endfor; ?>

                    <?php if($page < $total_pages): ?>
                      <li><a href='?module=tamanbaca2&page=<?php echo $page + 1; ?>'>Next &raquo;</a></li>
                    <?php endif; ?>
                  </ul>
	...
	<?php		  
	 break;
	   case "tambahtamanbaca2":
	  
	 ?>
	 <center><h3 class="box-title">TAMBAH DATA TAMAN BACAAN PKK</h3></center>
			...
			<div class="box box-info">
                ...
                <form class="form-horizontal" action="<?php echo $aksi;?>?module=tamanbaca2&act=input" method="POST" id="popup-validation" enctype="multipart/form-data">
				<div class="col-md-6">
                  <div class="box-body">
		...
		<div class="modal fade" id="myModal8" tabindex="-1" role="dialog" aria-labelledby="myModalLabel">
            <div class="modal-dialog" style="width:800px">
				...
				<div class="col-md-12">	
                  <div class="box-footer">
                    <a type="submit"  href="appmaster.php?module=tamanbaca2" name="cmtamanbaca" class="btn btn-danger"><i class="fa fa-remove"></i> Cancel</a>
