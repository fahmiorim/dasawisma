...
?>
   ...
   <form method="POST" class="form-horizontal" enctype="multipart/form-data" name="sipkunjungan" action="<?php echo $aksi;?>?module=sipkunjungan&act=update"id="popup-validation">
	<?php
