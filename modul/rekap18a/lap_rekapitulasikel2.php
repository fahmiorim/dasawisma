...
$id = $_GET['id'];
$res = pg_query($koneksi, "select * from ibubayi where kodekel='$_GET[kdkel]'");
$r = pg_fetch_array($res);

header("Content-Type: application/vnd.ms-excel");
header("Content-Disposition: attachment; filename=Rpt_RekapitulasiKel.xls");
  ...
  <tr>
    <td colspan="4">
      <table table width="1304" border="1" cellpadding="1" cellspacing="0" class="table table-bordered table-striped">
        ...
        $no = 1;
        $dasa = pg_query($koneksi, "select * from ibubayi where kodekel='$_GET[kdkel]'  order by namaibu");
        ...
        <!--<?php
            $total = pg_query($koneksi, "select count(namaibu) as totaldata from ibubayi where kodekel='$_SESSION[ses_kodekel]'");
