...
if(isset($_POST['chk'])=="")
{
    ...
    <script>
       ...
       window.location.href = 'appmaster.php?module=jlhtb0307list';
    </script>
    <?php
}
$chk = $_POST['chk'];
...
?>
     <center><h3 class="box-title">LIHAT DATA TAMAN BACAAN KELURAHAN SUMBER KARYA KOTA BINJAI</h3></center>
   ...
   <form method="POST" class="form-horizontal" enctype="multipart/form-data" action="<?php echo $aksi;?>?module=jlhtb0307list"id="popup-validation">
	<?php
        ...
        <input type="hidden" name="id" value="<?php echo $r['id'];?>" />
				<div class="col-md-6">
                   ...
                   <div class="form-group">
					  ...
					  <div class="col-sm-8">
                        <input type="text" class="validate[required] form-control" name="namatamanbaca" placeholder="Nama Taman Bacaan" value="<?php echo $r[namatamanbaca];?>"readonly>
                       </div>
					 </div>
				...
				<div class="col-md-6">
					...
					<label for="jlhbuku" class="col-sm-4 control-label">Jumlah Buku<span class="text-danger"> *</span></label>
					  <div class="col-sm-3">
					    <input type="text" class="validate[required,custom[number]] form-control" name="jlhbuku" id="jlhbuku" placeholder="Jumlah Buku" value="<?php echo $r[jlhbuku];?>"readonly>
                     </div>
					 </div>
