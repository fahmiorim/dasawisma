...
if(isset($_POST['chk'])=="")
{
    ...
    <script>
       ...
       window.location.href = 'appmaster.php?module=jlhpus0102list';
    </script>
    <?php
}
$chk = $_POST['chk'];
...
?>
   ...
   <form method="POST" class="form-horizontal" enctype="multipart/form-data" action="<?php echo $aksi;?>?module=jlhpus0102list"id="popup-validation">
	<?php
