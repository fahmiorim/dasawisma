		...
		default:
			...
			echo "
                ...
                <div class='box-header'>
                  <h2 class='box-title'>Laporan Data Catatan Keluarga Per Dasawisma</h2>";
?>
			<form method="post" name="frm">
				...
				<div style="text-align:right">
					...
					?>
						...
						<button class="btn bg-purple btn-flat margin" data-toggle="tooltip" data-placement="top" title="Print Per Dasawisma" onClick="print_records_rptkeluargakelds();"><i class="fa fa-print"></i> Print Per Dasawisma</button>
