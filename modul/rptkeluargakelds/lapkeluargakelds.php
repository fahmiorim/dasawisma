						...
						<div class="box-body table-responsive no-padding">
							<table id='example1' class='table table-bordered table-striped'>
								<script type="text/javascript">
									...
									function popup() {
										window.open('modul/rptkeluargakelds/lap_keluargakelds.php?kdkel=<?php echo $kodekelurahan; ?>')
									}
								</script>
								...
								<script type="text/javascript">
									...
									function popup2() {
										window.open('modul/rptkeluargakelds/lap_keluargakelds2.php?kdkel=<?php echo $kodekelurahan; ?>')
									}
								</script>
								...
								<div style="text-align:right">
									<a class="btn bg-green margin" data-toggle="tooltip" data-placement="top" title="Kembali" href="?module=rptkeluargakelds"><i class="fa fa-send"></i> Kembali</a>
