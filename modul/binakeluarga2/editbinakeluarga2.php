...
if(isset($_POST['chk'])=="")
{
    ...
    <script>
       ...
       window.location.href = 'appmaster.php?module=binakeluarga2';
    </script>
    <?php
}
$chk = $_POST['chk'];
...
?>
     <center><h3 class="box-title">EDIT DATA BINA KELUARGA BALITA</h3></center>
   ...
   <form method="POST" class="form-horizontal" enctype="multipart/form-data" action="<?php echo $aksi;?>?module=binakeluarga2&act=update"id="popup-validation">
	<?php
		for($i=0; $i<$chkcount; $i++)
		{
			$id = $chk[$i];
			$res=pg_query($koneksi, "select * from binakeluarga where id=".$id);
				...
				<div class="col-md-6">
				  ...
				  <div class="form-group">
					...
					<label for="jumlah" class="col-sm-4 control-label">Jumlah<span class="text-danger"> *</span></label>
					  <div class="col-sm-3">
					    <input type="text" class="validate[required,custom[number]] form-control" name="jumlah" id="jumlah" placeholder="Jumlah"value="<?php echo $r[jumlah];?>">
                     </div>
				</div>
        ...
        <div class="form-group">
               <div class="col-sm-offset-2 col-sm-5">
                <button class="btn bg-purple btn-flat margin"  name="cmdeditbinakeluarga" title="Edit" ><i class="fa fa-pencil"></i>
                   Edit
                </button>
