...
?>
     <center><h3 class="box-title">LIHAT DATA BINA KELUARGA BALITA</h3></center>
   ...
   <form method="POST" class="form-horizontal" enctype="multipart/form-data" action="<?php echo $aksi;?>?module=binakeluarga2"id="popup-validation">
	<?php
				...
				<div class="col-md-6">
				  ...
				  <div class="form-group">
					...
					<label for="jumlah" class="col-sm-4 control-label">Jumlah<span class="text-danger"> *</span></label>
					  <div class="col-sm-3">
					    <input type="text" class="validate[required,custom[number]] form-control" name="jumlah" id="jumlah" placeholder="Jumlah"value="<?php echo $r[jumlah];?>"readonly>
                     </div>
				</div>
