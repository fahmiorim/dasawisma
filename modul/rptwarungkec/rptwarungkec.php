...
if (empty($_SESSION['ses_user']) AND empty($_SESSION['ses_password'])){  
  ...
  switch($act){
    default:
	 $warung = pg_query($koneksi, "select * from warung where kodekec='$_SESSION[ses_kodekec]'");
  $count=pg_num_rows($warung);
	echo"
			
				<div class='box'>
                <div class='box-header'>
                  <h2 class='box-title'>Laporan Data Warung PKK Kecamatan $namakec</h2>";
                ?>
		 ...
		 <button class="btn bg-purple btn-flat margin"  data-toggle="tooltip" data-placement="top" title="Print Warung PKK"  onClick="print_records_rptwarungkec();" ><i class="fa fa-print"></i> Print Warung PKK</button>
