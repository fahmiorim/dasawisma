...
?>
     <center><h3 class="box-title">LIHAT DATA IBU MELAHIRKAN/NIFAS</h3></center>
   ...
   <form method="POST" class="form-horizontal" enctype="multipart/form-data" action="<?php echo $aksi;?>?module=melahirkan2"id="popup-validation">
	<?php
