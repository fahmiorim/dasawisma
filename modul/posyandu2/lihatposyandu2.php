...
?>
     <center><h3 class="box-title">LIHAT DATA POSYANDU</h3></center>
   ...
   <form method="POST" class="form-horizontal" enctype="multipart/form-data" action="<?php echo $aksi;?>?module=posyandu2"id="popup-validation">
	<?php
                   ...
                   <div class="form-group">
					...
					<div class="form-group">
					 ...
					 <div class="form-group">
					  ...
					  <div class="col-sm-8">
                        <textarea type="text" class="validate[required] form-control" name="namakader" placeholder="Nama Kader Posyandu"readonly><?php echo $r[namakader];?></textarea>
                       </div>
					 </div>
