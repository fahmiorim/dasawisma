...
if (empty($_SESSION['ses_user']) AND empty($_SESSION['ses_password'])){  
  header('location:404.php');
	...
	$aksi = "modul/posyandu2/aksi_posyandu2.php";
	 // mengatasi variabel yang belum di definisikan (notice undefined index)
  $act = isset($_GET['act']) ? $_GET['act'] : ''; 

  switch($act){
    default:
	 $kec = pg_query($koneksi, "SELECT * FROM posyandu");
  ...
  $total_pages = ceil($count / $limit);
	...
	echo"
                ...
                <div class='box-header'>
                  <h2 class='box-title'>DATA POSYANDU</h2>";
                ?>
          ...
          <a  class="btn bg-purple margin" data-toggle="tooltip" data-placement="top" title="Tambah" href="?module=posyandu2&act=tambahposyandu2"><i class="fa fa-send"></i> Tambah</a> 
		  
		<?php
		if($count > 0)
        {
		?>			 
			 <button class="btn bg-orange btn-flat margin"  data-toggle="tooltip" data-placement="top" title="lihat"  onClick="view_records_posyandu2();" ><i class="fa fa-desktop"></i> Lihat</button>
		  <button class="btn bg-olive btn-flat margin" data-toggle="tooltip" data-placement="top" title="Edit"  onClick="update_records_posyandu2();" ><i class="fa fa-edit"></i> Edit</button> 
		  <button class="btn btn-danger" data-toggle="tooltip" data-placement="top" title="Hapus"   onClick="delete_records_posyandu2();" ><i class="fa fa-remove"></i> Hapus </button>
		  </div>
			...
			?>
              ...
              ?> 
                ...
                <div class='box-footer'>
                  <ul class='pagination'>
                    <?php if($page > 1): ?>
                      <li><a href='?module=posyandu2&page=<?php echo $page - 1; ?>'>&laquo; Prev</a></li>
                    <?php endif; ?>
                    
                    <?php for($i = 1; $i <= $total_pages; $i++): ?>
                      <li class='<?php echo $i == $page ? 'active' : ''; ?>'>
                        <a href='?module=posyandu2&page=<?php echo $i; ?>'><?php echo $i; ?></a>
                      </li>
                    <?php endfor; ?>
                    
                    <?php if($page < $total_pages): ?>
                      <li><a href='?module=posyandu2&page=<?php echo $page + 1; ?>'>Next &raquo;</a></li>
                    <?php endif; ?>
                  </ul>
	...
	<?php		  
	 break;
	   case "tambahposyandu2":
	  
	 ?>
	 <center><h3 class="box-title">TAMBAH DATA POSYANDU</h3></center>
			...
			<div class="box box-info">
                ...
                <form class="form-horizontal" action="<?php echo $aksi;?>?module=posyandu2&act=input" method="POST" id="popup-validation" enctype="multipart/form-data">
				<div class="col-md-6">
                  <div class="box-body">
		...
		<div class="modal fade" id="myModal8" tabindex="-1" role="dialog" aria-labelledby="myModalLabel">
            <div class="modal-dialog" style="width:800px">
				...
				<div class="col-md-12">	
                  <div class="box-footer">
                    <a type="submit"  href="appmaster.php?module=posyandu2" name="cmposyandu" class="btn btn-danger"><i class="fa fa-remove"></i> Cancel</a>
