...
?>
     <center><h3 class="box-title">EDIT DATA POSYANDU</h3></center>
   ...
   <form method="POST" class="form-horizontal" enctype="multipart/form-data" action="<?php echo $aksi;?>?module=posyandu2&act=update"id="popup-validation">
	<?php
