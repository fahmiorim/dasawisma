...
if (empty($_SESSION['ses_user']) AND empty($_SESSION['ses_password'])){  
  header('location:404.php');
	...
	$aksi = "modul/saranamck/aksi_saranamck.php";
	 // mengatasi variabel yang belum di definisikan (notice undefined index)
  $act = isset($_GET['act']) ? $_GET['act'] : ''; 

  switch($act){
    default:
	 $kec = pg_query($koneksi, "SELECT * FROM saranamck");
  $count=pg_num_rows($kec);
	echo"
	
	<div class='box'>
                <div class='box-header'>
                  <h2 class='box-title'>DATA SARANA MCK</h2>";
                ?>
          ...
          <a  class="btn bg-purple margin" data-toggle="tooltip" data-placement="top" title="Tambah" href="?module=saranamck&act=tambahsaranamck"><i class="fa fa-send"></i> Tambah</a> 
		  
		<?php
		if($count > 0)
        {
		?>			 
			 <button class="btn bg-orange btn-flat margin"  data-toggle="tooltip" data-placement="top" title="lihat"  onClick="view_records_saranamck();" ><i class="fa fa-desktop"></i> Lihat</button>
		  <button class="btn bg-olive btn-flat margin" data-toggle="tooltip" data-placement="top" title="Edit"  onClick="update_records_saranamck();" ><i class="fa fa-edit"></i> Edit</button> 
		  <button class="btn btn-danger" data-toggle="tooltip" data-placement="top" title="Hapus"   onClick="delete_records_saranamck();" ><i class="fa fa-remove"></i> Hapus </button>
		  </div>
		...
		<?php } ?>	
				...
				<div class="box-body table-responsive no-padding">
                  <table id='example1' class='table table-bordered table-striped'>
					...
					<?php  
					$no = 1;
					$lingk =pg_query($koneksi, "select * from saranamck where kodekel='$_SESSION[ses_kodekel]' order by kodekel");
			...
			?>
					...
					<input  type="checkbox" name="chk[]" class="chk-box" value="<?php echo $lk['id'];?>"/>
						...
						<td><?php echo" $lk[jlhpintu]"; ?></td>
						<td><?php echo" $lk[saranalain]"; ?></td>
	...
	<?php		  
	 break;
	   case "tambahsaranamck":
	  
	 ?>
	 <center><h3 class="box-title">TAMBAH DATA SARANA MCK</h3></center>
			...
			<div class="box box-info">
                ...
                <form class="form-horizontal" action="<?php echo $aksi;?>?module=saranamck&act=input" method="POST" id="popup-validation" enctype="multipart/form-data">
				<div class="col-md-6">
                  <div class="box-body">
		...
		<div class="col-md-6">
             <div class="box-body">
				...
				<div class="form-group">
					<label for="jlhpintu" class="col-sm-4 control-label">Jumlah Pintu<span class="text-danger"> *</span></label>
					  <div class="col-sm-3">
					    <input type="text" class="validate[required,custom[number]] form-control" name="jlhpintu" id="jlhpintu" placeholder="Jumlah Pintu">
                     </div>
				</div>
				
					<div class="form-group">
					<label for="saranalain" class="col-sm-4 control-label">Sarana Lain<span class="text-danger"> *</span></label>
					  <div class="col-sm-7">
					    <input type="text" class="validate[required] form-control" name="saranalain" id="saranalain" placeholder="sarana lain">
                     </div>
					</div>
            ...
            <div class="modal-dialog" style="width:800px">
				...
				<div class="col-md-12">	
                  <div class="box-footer">
                    <a type="submit"  href="appmaster.php?module=saranamck" name="cmsaranamck" class="btn btn-danger"><i class="fa fa-remove"></i> Cancel</a>
