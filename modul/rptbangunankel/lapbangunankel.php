...
if (empty($_SESSION['ses_user']) and empty($_SESSION['ses_password'])) {
	...
	<div class='box'>
                <div class='box-header'>
                  <h2 class='box-title'>Laporan Taman Baca PKK Per Desa/Kelurahan</h2>";
						...
						<div class="box-body table-responsive no-padding">
							<table id='example1' class='table table-bordered table-striped'>
								<script type="text/javascript">
									...
									function popup() {
										window.open('modul/rpttamanbacakel/lap_tamanbacakel.php?kdkel=<?php echo $kodekelurahan; ?>')
									}
								</script>
								...
								<script type="text/javascript">
									...
									function popup2() {
										window.open('modul/rpttamanbacakel/lap_tamanbacakel2.php?kdkel=<?php echo $kodekelurahan; ?>')
									}
								</script>
								...
								<div style="text-align:right">
									<a class="btn bg-green margin" data-toggle="tooltip" data-placement="top" title="Kembali" href="?module=rpttamanbacakel"><i class="fa fa-send"></i> Kembali</a>
								...
								<tbody>
									...
									$dasa = pg_query($koneksi, "select * from tamanbaca where kodekel='$_SESSION[ses_kodekel]' order by lingkungan");
