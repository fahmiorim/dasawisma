...
header("Content-Disposition: attachment; filename=Rpt_TamanbacaKel.xls");
...
<table width="983" border="0">
  ...
  <tr>
    <td align="center"><span class="style4">LAPORAN TAMAN BACA PKK PER DESA/KELURAHAN </span></td>
  </tr>
  ...
  <tr>
    <td>
      <table width="977" border="1" cellpadding="0" cellspacing="0" class="table table-bordered table-striped">
        ...
        $no = 1;
        $tim = pg_query($koneksi, "select * from tamanbaca where kodekel='$_GET[kdkel]' order by lingkungan ");
