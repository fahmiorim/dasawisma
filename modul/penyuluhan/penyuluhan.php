...
if (empty($_SESSION['ses_user']) AND empty($_SESSION['ses_password'])){  
  header('location:404.php');
	...
	$aksi = "modul/penyuluhan/aksi_penyuluhan.php";
	 // mengatasi variabel yang belum di definisikan (notice undefined index)
  $act = isset($_GET['act']) ? $_GET['act'] : ''; 

  switch($act){
    default:
	 $kec = pg_query($koneksi, "SELECT * FROM penyuluhan");
  $count=pg_num_rows($kec);
	echo"
	
	<div class='box'>
                <div class='box-header'>
                  <h2 class='box-title'>DATA PENYULUHAN</h2>";
                ?>
          ...
          <a  class="btn bg-purple margin" data-toggle="tooltip" data-placement="top" title="Tambah" href="?module=penyuluhan&act=tambahpenyuluhan"><i class="fa fa-send"></i> Tambah</a> 
		  
		<?php
		if($count > 0)
        {
		?>			 
			 <button class="btn bg-orange btn-flat margin"  data-toggle="tooltip" data-placement="top" title="lihat"  onClick="view_records_penyuluhan();" ><i class="fa fa-desktop"></i> Lihat</button>
		  <button class="btn bg-olive btn-flat margin" data-toggle="tooltip" data-placement="top" title="Edit"  onClick="update_records_penyuluhan();" ><i class="fa fa-edit"></i> Edit</button> 
		  <button class="btn btn-danger" data-toggle="tooltip" data-placement="top" title="Hapus"   onClick="delete_records_penyuluhan();" ><i class="fa fa-remove"></i> Hapus </button>
		  </div>
		...
		<?php } ?>	
				...
				<div class="box-body table-responsive no-padding">
                  <table id='example1' class='table table-bordered table-striped'>
					...
					<?php  
					$no = 1;
					$lingk =pg_query($koneksi, "select * from penyuluhan where kodekel='$_SESSION[ses_kodekel]' order by kodekel");
			...
			?>
					...
					<input  type="checkbox" name="chk[]" class="chk-box" value="<?php echo $lk['id'];?>"/>
						...
						<td><?php echo" $lk[namapenyuluhan]"; ?></td>
						<td><?php echo" $lk[jlhkelompok]"; ?></td>
						<td><?php echo" $lk[jlhpenyuluh]"; ?></td>
						<td><?php echo" $lk[kaderlk]"; ?></td>
						<td><?php echo" $lk[kaderpr]"; ?></td>
	...
	<?php		  
	 break;
	   case "tambahpenyuluhan":
	  
	 ?>
	 <center><h3 class="box-title">TAMBAH DATA PENYULUHAN</h3></center>
			...
			<div class="box box-info">
                ...
                <form class="form-horizontal" action="<?php echo $aksi;?>?module=penyuluhan&act=input" method="POST" id="popup-validation" enctype="multipart/form-data">
				<div class="col-md-6">
                  <div class="box-body">
					...
					<div class="form-group">
					 <label for="namapenyuluhan" class="col-sm-4 control-label">Jenis Penyuluhan<span class="text-danger"> *</span></label>
					  <div class="col-sm-7">
                        <select class=" validate[required] form-control" name='namapenyuluhan' id='namapenyuluhan' >
							<option></option>
							<option value="PKBN">PKBN</option>
							<option value="KADARKUM">KADARKUM</option>
							<option value="POLA ASUH">POLA ASUH</option>
							<option value="TATA LAKSANA RT">TATA LAKSANA RT</option>
							<option value="BIDANG SANDANG">BIDANG SANDANG</option>
							<option value="BIDANG PANGAN">BIDANG PANGAN</option>
							<option value="BINA KELUARGA BALITA">BINA KELUARGA BALITA</option>
						</select>
                      </div>
					</div>
             ...
             <div class="box-body">
				...
				<div class="form-group">
					<label for="jlhkelompok" class="col-sm-4 control-label">Jumlah Kelompok<span class="text-danger"> *</span></label>
					  <div class="col-sm-3">
					    <input type="text" class="validate[required,custom[number]] form-control" name="jlhkelompok" id="jlhkelompok" placeholder="Jumlah Kelompok">
                     </div>
				</div>
					
				<div class="form-group">
					<label for="jlhpenyuluh" class="col-sm-4 control-label">Jumlah Penyuluhan<span class="text-danger">*</span></label>
					  <div class="col-sm-3">
					    <input type="text" class="validate[required,custom[number]] form-control" name="jlhpenyuluh" id="jlhpenyuluh" placeholder="Jumlah Penyuluhan">
                     </div>
				</div>
					
				<div class="form-group">
					<label for="jlhkader" class="col-sm-4 control-label">Jumlah Kader</label>
				</div>
					
				<div class="form-group">
					<label for="kaderlk" class="col-sm-4 control-label">Laki-Laki<span class="text-danger">*</span></label>
					  <div class="col-sm-3">
					    <input type="text" class="validate[required,custom[number]] form-control" name="kaderlk" id="kaderlk" placeholder="Laki-Laki">
                     </div>
				</div>
				
				<div class="form-group">
					<label for="kaderpr" class="col-sm-4 control-label">Perempuan<span class="text-danger">*</span></label>
					  <div class="col-sm-3">
					    <input type="text" class="validate[required,custom[number]] form-control" name="kaderpr" id="kaderpr" placeholder="Perempuan">
                     </div>
				</div>
            ...
            <div class="modal-dialog" style="width:800px">
				...
				<div class="col-md-12">	
                  <div class="box-footer">
                    <a type="submit"  href="appmaster.php?module=penyuluhan" name="cmpenyuluhan" class="btn btn-danger"><i class="fa fa-remove"></i> Cancel</a>
