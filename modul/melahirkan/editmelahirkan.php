...
?>
     <center><h3 class="box-title">EDIT DATA IBU MELAHIRKAN/NIFAS</h3></center>
   ...
   <form method="POST" class="form-horizontal" enctype="multipart/form-data" action="<?php echo $aksi;?>?module=melahirkan&act=update"id="popup-validation">
	<?php
		for($i=0; $i<$chkcount; $i++)
		{
			$id = $chk[$i];
			$res=pg_query($koneksi, "select * from melahirkan where id=".$id);
