<script type="text/javascript">
	...
	<script type="text/javascript">
    $(function() {
        $( "#tglmelahirkan" ).datepicker({ altFormat: 'yy-mm-dd' });
...
if (empty($_SESSION['ses_user']) AND empty($_SESSION['ses_password'])){  
  header('location:404.php');
	...
	$aksi = "modul/melahirkan/aksi_melahirkan.php";
	 // mengatasi variabel yang belum di definisikan (notice undefined index)
  $act = isset($_GET['act']) ? $_GET['act'] : ''; 

  switch($act){
    default:
	 $kec = pg_query($koneksi, "SELECT * FROM melahirkan order by namaibu");
  $count=pg_num_rows($kec);
	echo"
	
	<div class='box'>
                <div class='box-header'>
                  <h2 class='box-title'>DATA IBU MELAHIRKAN DAN NIFAS</h2>";
                ?>
          ...
          <a  class="btn bg-purple margin" data-toggle="tooltip" data-placement="top" title="Tambah" href="?module=melahirkan&act=tambahmelahirkan"><i class="fa fa-send"></i> Tambah</a> 
		  
		<?php
		if($count > 0)
        {
		?>			 
			 <button class="btn bg-orange btn-flat margin"  data-toggle="tooltip" data-placement="top" title="lihat"  onClick="view_records_melahirkan();" ><i class="fa fa-desktop"></i> Lihat</button>
		  <button class="btn bg-olive btn-flat margin" data-toggle="tooltip" data-placement="top" title="Edit"  onClick="update_records_melahirkan();" ><i class="fa fa-edit"></i> Edit</button> 
		  <button class="btn btn-danger" data-toggle="tooltip" data-placement="top" title="Hapus"   onClick="delete_records_melahirkan();" ><i class="fa fa-remove"></i> Hapus </button>
		  </div>
		...
		<?php } ?>	
				...
				<div class="box-body table-responsive no-padding">
                  <table id='example1' class='table table-bordered table-striped'>
					...
					<?php  
					$no = 1;
					$lingk =pg_query($koneksi, "select * from melahirkan where kodekel='$_SESSION[ses_kodekel]' order by namaibu");
			...
			?>
					...
					<input  type="checkbox" name="chk[]" class="chk-box" value="<?php echo $lk['id'];?>"/>
						...
						<td><?php echo" $lk[tglmelahirkan]"; ?></td>
						<td><?php echo" $lk[nik]"; ?></td>
						<td><?php echo" $lk[namaibu]"; ?></td>
						<td><?php echo" $lk[namasuami]"; ?></td>
						<td><?php echo" $lk[namabayi]"; ?></td>
						<td><?php echo" $lk[jenkel]"; ?></td>
						<td><?php echo" $lk[statusibu]"; ?></td>
						<td><?php echo" $lk[akte]"; ?></td>
	...
	<?php		  
	 break;
	   case "tambahmelahirkan":
	  
	 ?>
	 <center><h3 class="box-title">TAMBAH DATA IBU MELAHIRKAN/NIFAS</h3></center>
			...
			<div class="box box-info">
                ...
                <form class="form-horizontal" action="<?php echo $aksi;?>?module=melahirkan&act=input" method="POST" id="popup-validation" enctype="multipart/form-data">
				<div class="col-md-6">
                  <div class="box-body">
					...
					<div class="form-group">
                      ...
                      <div class="col-sm-4">
                        <input type="text" class="validate[required,custom[date]] form-control" id="tglmelahirkan" name="tglmelahirkan" placeholder="YYYY-MM-DD">
                      </div>
					</div>
             ...
             <div class="box-body">
				<div class="form-group">	
					...
					<label for="namabayi" class="col-sm-4 control-label">Nama Bayi<span class="text-danger"> *</span></label>
					  <div class="col-sm-7">
					    <input type="text" class="validate[required] form-control" name="namabayi" id="namabayi" placeholder="Nama Bayi">
                     </div>
					 </div>
					...
					<div class="form-group">
					 <label for="akte" class="col-sm-4 control-label">Memiliki Akte Lahir<span class="text-danger">*</span></label>
					  <div class="col-sm-4">
                        <select class=" validate[required] form-control" name='akte' id='akte' >
							<option></option>
            ...
            <div class="modal-dialog" style="width:800px">
                    ...
                    <div class="modal-body">
                        <table id="example3" class="table table-bordered table-striped">
                            ...
                            <tbody>
                                ...
                                $qu = pg_query($koneksi, "SELECT * FROM datawarga where jenkel='Perempuan' and kodekel='$_SESSION[ses_kodekel]' order by nik");
				...
				<div class="col-md-12">	
                  <div class="box-footer">
                    <a type="submit"  href="appmaster.php?module=melahirkan" name="cmdmelahirkan" class="btn btn-danger"><i class="fa fa-remove"></i> Cancel</a>
