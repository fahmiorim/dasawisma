...
header("Content-Disposition: attachment; filename=Rpt_PelatihanKota.xls");
		...
		<td>
			<table width="1968" border="1" cellpadding="0" cellspacing="0" class="table table-bordered table-striped">
				<tr>
					...
					<td width="86" align="center">Desa/Kelurahan</td>
				...
				$no = 1;
				$tim = pg_query($koneksi, "select * from pelatihan order by lingkungan ");
