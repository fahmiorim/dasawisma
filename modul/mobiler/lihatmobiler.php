...
?>
			...
			?>
			<center>
				<h3 class="box-title">LIHAT DATA MOBILER PKK</h3>
			</center>
			...
			<div class="box box-info">
				...
				<form method="POST" class="form-horizontal" enctype="multipart/form-data" action="<?php echo $aksi; ?>?module=mobiler" id="popup-validation">
					<?php
						...
						<div class="col-md-6">
							<div class="box-body">
								...
								<div class="form-group">
									...
									<div class="col-sm-8">
										<input type="text" class="validate[required] form-control" name="nama_mobiler" placeholder="Nama Mobiler" value="<?php echo $r[nama_mobiler]; ?>" readonly>
									</div>
								</div>
