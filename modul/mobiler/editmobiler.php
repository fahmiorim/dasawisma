...
?>
				<script>
					...
					window.location.href = 'appmaster.php?module=mobiler';
				</script>
			<?php
			}
			$chk = $_POST['chk'];
			...
			?>
			<center>
				<h3 class="box-title">EDIT DATA MOBILER PKK</h3>
			</center>
			...
			<div class="box box-info">
				...
				<form method="POST" class="form-horizontal" enctype="multipart/form-data" action="<?php echo $aksi; ?>?module=mobiler&act=update" id="popup-validation">
					<?php
					for ($i = 0; $i < $chkcount; $i++) {
						$id = $chk[$i];
						$res = pg_query($koneksi, "select * from mobiler where id=" . $id);
						...
						<div class="col-md-6">
							<div class="box-body">
								...
								<div class="form-group">
									...
									<div class="col-sm-8">
										<input type="text" class="validate[required] form-control" name="nama_mobiler" placeholder="Nama Mobiler" value="<?php echo $r[nama_mobiler]; ?>">
									</div>
								</div>
					...
					<div class="form-group">
						<div class="col-sm-offset-2 col-sm-5">
							<button class="btn bg-purple btn-flat margin" name="cmdeditmobiler" title="Edit"><i class="fa fa-pencil"></i>
								Edit
							</button>
