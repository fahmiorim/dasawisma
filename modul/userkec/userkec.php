  ...
  $total_pages = ceil($count / $limit);
	...
	echo"
                ...
                <div class='box-header'>
                  <h2 class='box-title'>Pembuatan User Kecamatan</h2>
				</div>  ";
                ?>
				<form method="post" name="frm">
		
			<div style="text-align:right">		
          <a  class="btn bg-purple margin"  title="Tambah" href="?module=userkec&act=tambahuser"><i class="fa fa-plus"></i> Tambah</a> 
		  
		<?php
		if($count > 0)
        {
		?>			  
		  <button class="btn bg-olive btn-flat margin"  title="Edit"  onClick="update_records_userkec();" ><i class="fa fa-edit"></i> Edit</button> 
		  <button class="btn btn-danger"  title="Hapus"   onClick="hapus_records_userkec();" ><i class="fa fa-remove"></i> Hapus </button>
		  </div>
		...
		<?php } ?>	
                ...
                <div class='box-body'>
                  <table id='example1' class='table table-bordered table-striped'>
					...
					<?php  
					$no = $offset + 1;
					$ush =pg_query($koneksi, "select * from users where level='admkec' order by kodekec LIMIT $limit OFFSET $offset");
              ...
              ?> 
                ...
                <div class='box-footer clearfix'>
                  <ul class='pagination pagination-sm no-margin pull-right'>
                    ...
                    if($page > 1){
                      $prev = $page - 1;
                      echo "<li><a href=\"?module=userkec&page=1\">&laquo;</a></li>";
                      echo "<li><a href=\"?module=userkec&page=$prev\">&lsaquo;</a></li>";
                    }
                    for($i=$start; $i<=$end; $i++){
                      $aktif = ($i == $page) ? "class=\"active\"" : "";
                      echo "<li $aktif><a href=\"?module=userkec&page=$i\">$i</a></li>";
                    }
                    if($page < $total_pages){
                      $next = $page + 1;
                      echo "<li><a href=\"?module=userkec&page=$next\">&rsaquo;</a></li>";
                      echo "<li><a href=\"?module=userkec&page=$total_pages\">&raquo;</a></li>";
                    }
                    ?>
                  </ul>
	...
	<?php		  
	 ...
	 ?>
	 <center><h3 class="box-title">Pembuatan User Kecamatan</h3></center>
			...
			<div class="box box-info">
                ...
                <form class="form-horizontal" action="<?php echo $aksi;?>?module=userkec&act=input" method="POST" enctype="multipart/form-data" id="popup-validation">
				<div class="col-md-6">
                  <div class="box-body">
				  ...
				  <div class="form-group">
					...
					<div class="form-group">
					 <label for="nohp" class="col-sm-4 control-label">No.HP/Telepon</label>
					  <div class="col-sm-7">
                        <input type="text" class="validate[required] form-control" name="nohp" placeholder="No.HP/Telepon" >
                      </div>
                    </div>
            ...
            <div class="modal-dialog" style="width:800px">
				...
				<div class="col-md-12">	
                  <div class="box-footer">
                    <a type="submit"  href="appmaster.php?module=userkec" class="btn btn-danger"><i class="fa fa-remove"></i> Cancel</a>
