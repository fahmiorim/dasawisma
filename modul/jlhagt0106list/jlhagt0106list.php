...
if (empty($_SESSION['ses_user']) AND empty($_SESSION['ses_password'])){  
  ...
  switch($act){
    default:
	 $jlhagt0106list = pg_query($koneksi, "SELECT * FROM keluarga where tahun='$_SESSION[thnaktif]' and kodekel='0106'");
  $count=pg_num_rows($jlhagt0106list);
	echo"
	...
	<div class='box'>
        ...
        {
		?>			
		   <button class="btn bg-orange btn-flat margin" data-toggle="tooltip" data-placement="top" title="Detail"  onClick="view_records_jlhagt0106list();" ><i class="fa fa-desktop"></i> Detail</button>
		...
		<?php } ?>	
				...
				<div class="box-body table-responsive no-padding">
                  <table id='example1' class='table table-bordered table-striped'>
					...
					<?php  
					$no = 1;
					$lingk =pg_query($koneksi, "select * from keluarga where tahun='$_SESSION[thnaktif]' and kodekel='0106' order by lingkungan");
