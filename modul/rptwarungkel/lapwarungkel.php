				...
				<div class="box-body table-responsive no-padding">
                  <table id='example1' class='table table-bordered table-striped'>
							<script type="text/javascript">
								...
								function popup() {
								window.open('modul/rptwarungkel/lap_warungkel.php?kdkel=<?php echo $kodekelurahan;?>')
								}
							</script>
							...
							<script type="text/javascript">
								var s5_taf_parent = window.location;
								function popup2() {
								window.open('modul/rptwarungkel/lap_warungkel2.php?kdkel=<?php echo $kodekelurahan;?>')
								}
							</script>
					...
					<label for="nmkel" class="col-sm-1 control-label">Nama</label>
                      <div class="col-sm-3">
						...
						<input type="text" class="form-control" id="nmkel" name="nmkel" placeholder="Nama Kelurahan" value="<?php echo "$_SESSION[ses_namakel]";?>">
								...
								<div style="text-align:right">	
								 <a  class="btn bg-green margin"  data-toggle="tooltip" data-placement="top" title="Kembali" href="?module=rptwarungkel"><i class="fa fa-send"></i> Kembali</a>
