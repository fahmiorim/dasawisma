...
if(isset($_POST['chk'])=="")
{
    ...
    <script>
       ...
       window.location.href = 'appmaster.php?module=jlhmelahirkan0307list';
    </script>
    <?php
}
$chk = $_POST['chk'];
...
?>
     <center><h3 class="box-title">LIHAT CATATAN IBU HAMIL, MELAHIRKAN, NIFAS, IBU MENINGGAL*, KELAHIRAN BAYI, BAYI MENINGGAL DAN KEMATIAN BALITA KELURAHAN SUMBER KARYA KOTA BINJAI</h3></center>
   ...
   <form method="POST" class="form-horizontal" enctype="multipart/form-data" action="<?php echo $aksi;?>?module=jlhmelahirkan0307list"id="popup-validation">
	<?php
        ...
        <input type="hidden" name="id" value="<?php echo $r['id'];?>" />
				<div class="col-md-6">
                   ...
                   <div class="form-group">
					 <label for="bulan" class="col-sm-4 control-label">Bulan<span class="text-danger"> *</span></label>
					  <div class="col-sm-5">
                        <select class=" validate[required] form-control" name='bulan' id='bulan' readonly>
					...
					<label for="jlhbumil" class="col-sm-4 control-label">Jumlah Ibu Hamil<span class="text-danger"> *</span></label>
					  <div class="col-sm-4">
					    <input type="text" class="validate[required,custom[number]] form-control" name="jlhbumil" id="jlhbumil" value="<?php echo $r[jlhbumil];?>" placeholder="Ibu Hamil"readonly>
                     </div>
					 </div>
					...
					<label for="jlhmelahirkan" class="col-sm-4 control-label">Jumlah Ibu Melahirkan<span class="text-danger"> *</span></label>
					  <div class="col-sm-4">
					    <input type="text" class="validate[required,custom[number]] form-control" name="jlhmelahirkan" id="jlhmelahirkan" value="<?php echo $r[jlhmelahirkan];?>" placeholder="Ibu Melahirkan"readonly>
                     </div>
					 </div>
					...
					<label for="jlhnifas" class="col-sm-4 control-label">Jumlah Ibu Nifas<span class="text-danger"> *</span></label>
					  <div class="col-sm-4">
					    <input type="text" class="validate[required,custom[number]] form-control" name="jlhnifas" id="jlhnifas" value="<?php echo $r[jlhnifas];?>" placeholder="Ibu Nifas"readonly>
                     </div>
					 </div>
					...
					<label for="jlhmeninggal" class="col-sm-4 control-label">Jumlah Ibu Meninggal<span class="text-danger"> *</span></label>
					  <div class="col-sm-4">
					    <input type="text" class="validate[required,custom[number]] form-control" name="jlhmeninggal" id="jlhmeninggal" value="<?php echo $r[jlhmeninggal];?>" placeholder="Ibu Meninggal"readonly>
                     </div>
					 </div>
				...
				<div class="col-md-6">
					...
					<label for="bayilahirl" class="col-sm-4 control-label">Jlh Bayi Lahir LK<span class="text-danger"> *</span></label>
					  <div class="col-sm-4">
					    <input type="text" class="validate[required,custom[number]] form-control" name="bayilahirl" id="bayilahirl" value="<?php echo $r[bayilahirl];?>" placeholder="Bayi Lahir LK"readonly>
                     </div>
					 </div>
					...
					<label for="bayilahirp" class="col-sm-4 control-label">Jlh Bayi Lahir Pr<span class="text-danger"> *</span></label>
					  <div class="col-sm-4">
					    <input type="text" class="validate[required,custom[number]] form-control" name="bayilahirp" id="bayilahirp" value="<?php echo $r[bayilahirp];?>" placeholder="Bayi Lahir Pr"readonly>
                     </div>
					 </div>
					...
					<div class="form-group">
					 <label for="akte" class="col-sm-4 control-label">Akte Kelahiran</label>
					  <div class="col-sm-5">
                        <select class="form-control" name='akte' id='akte' readonly>
					...
					<label for="bayimeninggalk" class="col-sm-4 control-label">Bayi Meninggal LK<span class="text-danger"> *</span></label>
					  <div class="col-sm-5">
					    <input type="text" class="validate[required,custom[number]] form-control" name="bayimeninggalk" id="bayimeninggalk" value="<?php echo $r[bayimeninggalk];?>" placeholder="Bayi Meninggal LK"readonly>
                     </div>
					 </div>
					...
					<label for="bayimeninggalp" class="col-sm-4 control-label">Bayi Meninggal Pr<span class="text-danger"> *</span></label>
					  <div class="col-sm-5">
					    <input type="text" class="validate[required,custom[number]] form-control" name="bayimeninggalp" id="bayimeninggalp" value="<?php echo $r[bayimeninggalp];?>" placeholder="Bayi Meninggal Pr"readonly>
                     </div>
					 </div>
					...
					<label for="balital" class="col-sm-4 control-label">Balita Meninggal LK<span class="text-danger">*</span></label>
					  <div class="col-sm-5">
					    <input type="text" class="validate[required,custom[number]] form-control" name="balital" id="balital" value="<?php echo $r[balital];?>" placeholder="Balita Meninggal LK"readonly>
                     </div>
					 </div>
					...
					<label for="balitap" class="col-sm-4 control-label">Balita Meninggal Pr<span class="text-danger">*</span></label>
					  <div class="col-sm-5">
					    <input type="text" class="validate[required,custom[number]] form-control" name="balitap" id="balitap" value="<?php echo $r[balitap];?>" placeholder="Balita Meninggal Pr"readonly>
                     </div>
					 </div>
