...
$id = $_GET['id'];
$res = pg_query($koneksi, "select * from posyandu order by kelurahan");
$r = pg_fetch_array($res);

header("Content-Type: application/vnd.ms-excel");
header("Content-Disposition: attachment; filename=Rpt_Posyandu.xls");
...
<table width="983" border="0">
	...
	<tr>
		<td align="center"><span class="style1">LAPORAN PROFIL POSYANDU </span></td>
	</tr>
	...
	<tr>
		<td>
			<table width="977" border="1" cellpadding="0" cellspacing="0" class="table table-bordered table-striped">
				...
				$no = 1;
				$tim = pg_query($koneksi, "select * from posyandu order by kelurahan ");
