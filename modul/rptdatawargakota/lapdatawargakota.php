				...
				<div class="box-body table-responsive no-padding">
                  <table id='example1' class='table table-bordered table-striped'>
							<script type="text/javascript">
								...
								function popup() {
								window.open('modul/rptdatawargakota/lap_datawargakota.php')
								}
							</script>
							...
							<script type="text/javascript">
								var s5_taf_parent = window.location;
								function popup2() {
								window.open('modul/rptdatawargakota/lap_datawargakota2.php')
								}
							</script>
				
					
								<div style="text-align:right">	
								 <a  class="btn bg-green margin"  data-toggle="tooltip" data-placement="top" title="Kembali" href="?module=rptdatawargakota"><i class="fa fa-send"></i> Kembali</a>
					...
					$dasa =pg_query($koneksi, "select * from datawarga");
