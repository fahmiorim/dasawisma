...
if (empty($_SESSION['ses_user']) and empty($_SESSION['ses_password'])) {
  ...
  switch ($act) {
    default:
      $sipkunjungan = pg_query($koneksi, "select * from sipkunjungan where tahun='$_SESSION[thnaktif]' and kodekel='$_SESSION[ses_kodekel]' order by tahun desc,nobln");
      ...
      <form method="post" name="frm">
        ...
        <div style="text-align:right">
          ...
          ?>
            ...
            <button class="btn bg-blue btn-flat margin" data-toggle="tooltip" data-placement="top" title="Print Tahunan" onClick="print_records_rptsipkunjunganthn();"><i class="fa fa-print"></i>Tahunan</button>
        ...
        <div class="box-body table-responsive no-padding">
          <table id='example1' class='table table-bordered table-striped'>
            ...
            <tbody>
              ...
              $tim = pg_query($koneksi, "select * from sipkunjungan where tahun='$_SESSION[thnaktif]' and kodekel='$_SESSION[ses_kodekel]' order by tahun desc,nobln ");
            ...
            <div class="modal-body">
              <table id="example3" class="table table-bordered table-striped">
                ...
                <tbody>
                  ...
                  $qu = pg_query($koneksi, "SELECT * FROM posyandu where kodekel='$_SESSION[ses_kodekel]' order by id desc");
