...
<input type="hidden" name="id" value="<?php echo $r['id'];?>" />
  ...
  <tr>
    <td><table width="1358" border="1" cellpadding="0" cellspacing="0" class="table table-bordered table-striped">
      <tr>
					...
					<td width="101"  align="center">Kelurahan</td>
	  ...
	  <?php
					...
					$no = 1;
					$dasa =pg_query($koneksi, "select * from pelatihan where kodekec='$_GET[kdkec]' order by lingkungan ");
