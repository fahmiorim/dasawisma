				...
				<div class="box-body table-responsive no-padding">
                  <table id='example1' class='table table-bordered table-striped'>
							<script type="text/javascript">
								...
								function popup() {
								window.open('modul/rptpelatihankec/lap_pelatihankec.php?kdkec=<?php echo $kodekecamatan;?>')
								}
							</script>
							...
							<script type="text/javascript">
								var s5_taf_parent = window.location;
								function popup2() {
								window.open('modul/rptpelatihankec/lap_pelatihankec2.php?kdkec=<?php echo $kodekecamatan;?>')
								}
							</script>
					...
					<label for="kdkelurahan" class="col-sm-1 control-label">Kode</label>
                      ...
                      <div class="col-sm-2">
						...
						<input type="text" class="form-control" id="nmkecamatan" name="nmkecamatan" placeholder="Nama Kecamatan" value="<?php echo "$namakecamatan";?>"readonly>
								...
								<div style="text-align:right">	
								 <a  class="btn bg-green margin"  data-toggle="tooltip" data-placement="top" title="Kembali" href="?module=rptpelatihankec"><i class="fa fa-send"></i> Kembali</a>
