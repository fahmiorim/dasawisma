...
if (empty($_SESSION['ses_user']) AND empty($_SESSION['ses_password'])){
 header('location:../../404.php');
	...
	$aksi = "modul/sipkunjungan2/aksi_sipkunjungan.php";
...
if(isset($_POST['chk'])=="")
{
    ...
    <script>
       ...
       window.location.href = 'appmaster.php?module=sipkunjungan2';
    </script>
    <?php
}
$chk = $_POST['chk'];
...
?>
     <center><h3 class="box-title">Edit Data Kunjungan Posyandu</h3></center>
   ...
   <form method="POST" class="form-horizontal" enctype="multipart/form-data" name="sipkunjungan2" action="<?php echo $aksi;?>?module=sipkunjungan2&act=update"id="popup-validation">
	<?php
        ...
        <input type="hidden" name="id" value="<?php echo $r['id'];?>" />
				  ...
				  <div class="form-group">
					...
					<div class="form-group">  
					 <label for="balitabarul12" class="col-sm-4 control-label">Laki-Laki <span class="text-danger"> *</span></label>
					  <div class="col-sm-3">
                        <input type="text" class="validate[required,custom[number]] form-control" name="balitabarul12" value="<?php echo $r[balitabarul12];?>"placeholder="0-12 Bln Baru Laki-Laki">
                      </div>
					</div>
					...
					<div class="form-group">  
					 <label for="balitabarup12" class="col-sm-4 control-label">Perempuan <span class="text-danger"> *</span></label>
					  <div class="col-sm-3">
                        <input type="text" class="validate[required,custom[number]] form-control" name="balitabarup12" value="<?php echo $r[balitabarup12];?>"placeholder="0-12 Bln Baru Perempuan">
                      </div>
					</div>
					...
					<div class="form-group">  
					 <label for="balitalamal12" class="col-sm-4 control-label">Laki-Laki <span class="text-danger"> *</span></label>
					  <div class="col-sm-3">
                        <input type="text" class="validate[required,custom[number]] form-control" name="balitalamal12" value="<?php echo $r[balitalamal12];?>"placeholder="0-12 Bln Lama Laki-Laki">
                      </div>
					</div>
					...
					<div class="form-group">  
					 <label for="balitalamap12" class="col-sm-4 control-label">Perempuan <span class="text-danger"> *</span></label>
					  <div class="col-sm-3">
                        <input type="text" class="validate[required,custom[number]] form-control" name="balitalamap12" value="<?php echo $r[balitalamap12];?>"placeholder="0-12 Bln Lama Perempuan">
                      </div>
					</div>
					...
					<div class="form-group">  
					 <label for="balitabarul5" class="col-sm-4 control-label">Laki-Laki <span class="text-danger"> *</span></label>
					  <div class="col-sm-3">
                        <input type="text" class="validate[required,custom[number]] form-control" name="balitabarul5" value="<?php echo $r[balitabarul5];?>"placeholder="1-5 Thn Baru Laki-Laki">
                      </div>
					</div>
					...
					<div class="form-group">  
					 <label for="balitabarup5" class="col-sm-4 control-label">Perempuan <span class="text-danger"> *</span></label>
					  <div class="col-sm-3">
                        <input type="text" class="validate[required,custom[number]] form-control" name="balitabarup5" value="<?php echo $r[balitabarup5];?>"placeholder="1-5 Thn Baru Perempuan">
                      </div>
					</div>
					...
					<div class="form-group">  
					 <label for="balitalamal5" class="col-sm-4 control-label">Laki-Laki <span class="text-danger"> *</span></label>
					  <div class="col-sm-3">
                        <input type="text" class="validate[required,custom[number]] form-control" name="balitalamal5" value="<?php echo $r[balitalamal5];?>" placeholder="1-5 Thn Lama Laki-Laki">
                      </div>
					</div>
					...
					<div class="form-group">  
					 <label for="balitalamap5" class="col-sm-4 control-label">Perempuan <span class="text-danger"> *</span></label>
					  <div class="col-sm-3">
                        <input type="text" class="validate[required,custom[number]] form-control" name="balitalamap5" value="<?php echo $r[balitalamap5];?>" placeholder="1-5 Thn Lama Perempuan">
                      </div>
					</div>
					...
					<div class="form-group">  
					 <label for="wus" class="col-sm-4 control-label">Sasaran <span class="text-danger"> *</span></label>
					  <div class="col-sm-3">
                        <input type="text" class="validate[required,custom[number]] form-control" name="wus" value="<?php echo $r[wus];?>"placeholder="Sasaran">
                      </div>
					</div>
					...
					<div class="form-group">  
					 <label for="wusyd" class="col-sm-4 control-label">Yang Datang <span class="text-danger"> *</span></label>
					  <div class="col-sm-3">
                        <input type="text" class="validate[required,custom[number]] form-control" name="wusyd" value="<?php echo $r[wusyd];?>"placeholder="Yang Datang">
                      </div>
					</div>
				...
				<div class="form-group">  
					 <label for="pus" class="col-sm-4 control-label">Sasaran <span class="text-danger"> *</span></label>
					  <div class="col-sm-3">
                        <input type="text" class="validate[required,custom[number]] form-control" name="pus" value="<?php echo $r[pus];?>" placeholder="Sasaran">
                      </div>
					</div>
				...
				<div class="form-group">  
					 <label for="pusyd" class="col-sm-4 control-label">Yang Datang <span class="text-danger"> *</span></label>
					  <div class="col-sm-3">
                        <input type="text" class="validate[required,custom[number]] form-control" name="pusyd" value="<?php echo $r[pusyd];?>" placeholder="Yang Datang">
                      </div>
					</div>
				...
				<div class="form-group">  
					 <label for="hamil" class="col-sm-4 control-label">Sasaran <span class="text-danger"> *</span></label>
					  <div class="col-sm-3">
                        <input type="text" class="validate[required,custom[number]] form-control" name="hamil" value="<?php echo $r[hamil];?>"placeholder="Sasaran">
                      </div>
					</div>
					...
					<div class="form-group">  
					 <label for="hamilyd" class="col-sm-4 control-label">Yang Datang <span class="text-danger"> *</span></label>
					  <div class="col-sm-3">
                        <input type="text" class="validate[required,custom[number]] form-control" name="hamilyd" value="<?php echo $r[hamilyd];?>" placeholder="Yang Datang">
                      </div>
					</div>
				...
				<div class="form-group">  
					 <label for="menyusui" class="col-sm-4 control-label">Sasaran <span class="text-danger"> *</span></label>
					  <div class="col-sm-3">
                        <input type="text" class="validate[required,custom[number]] form-control" name="menyusui" value="<?php echo $r[menyusui];?>" placeholder="Sasaran">
                      </div>
					</div>
					...
					<div class="form-group">  
					 <label for="menyusuiyd" class="col-sm-4 control-label">Yang Datang <span class="text-danger"> *</span></label>
					  <div class="col-sm-3">
                        <input type="text" class="validate[required,custom[number]] form-control" name="menyusuiyd" value="<?php echo $r[menyusuiyd];?>" placeholder="Yang Datang">
                      </div>
					</div>
					...
					<div class="form-group">  
					 <label for="kaderl" class="col-sm-4 control-label">Laki-Laki <span class="text-danger"> *</span></label>
					  <div class="col-sm-3">
                        <input type="text" class="validate[required,custom[number]] form-control" name="kaderl" value="<?php echo $r[kaderl];?>" placeholder="Laki-Laki">
                      </div>
					</div>
				...
				<div class="form-group">  
					 <label for="kaderp" class="col-sm-4 control-label">Perempuan <span class="text-danger"> *</span></label>
					  <div class="col-sm-3">
                        <input type="text" class="validate[required,custom[number]] form-control" name="kaderp" value="<?php echo $r[kaderp];?>" placeholder="Perempuan">
                      </div>
					</div>
					...
					<div class="form-group">  
					 <label for="plkbl" class="col-sm-4 control-label">Laki-Laki <span class="text-danger"> *</span></label>
					  <div class="col-sm-3">
                        <input type="text" class="validate[required,custom[number]] form-control" name="plkbl" value="<?php echo $r[plkbl];?>"placeholder="Laki-Laki">
                      </div>
					</div>
				...
				<div class="form-group">  
					 <label for="plkbp" class="col-sm-4 control-label">Perempuan <span class="text-danger"> *</span></label>
					  <div class="col-sm-3">
                        <input type="text" class="validate[required,custom[number]] form-control" name="plkbp" value="<?php echo $r[plkbp];?>"placeholder="Perempuan">
                      </div>
					</div>
					...
					<div class="form-group">  
					 <label for="medisl" class="col-sm-4 control-label">Laki-Laki <span class="text-danger"> *</span></label>
					  <div class="col-sm-3">
                        <input type="text" class="validate[required,custom[number]] form-control" name="medisl" value="<?php echo $r[medisl];?>" placeholder="Laki-Laki">
                      </div>
					</div>
				...
				<div class="form-group">  
					 <label for="medisp" class="col-sm-4 control-label">Perempuan <span class="text-danger"> *</span></label>
					  <div class="col-sm-3">
                        <input type="text" class="validate[required,custom[number]] form-control" name="medisp" value="<?php echo $r[medisp];?>"placeholder="Perempuan">
                      </div>
					</div>
					...
					<div class="form-group">  
					 <label for="bayil" class="col-sm-4 control-label">Laki-Laki <span class="text-danger"> *</span></label>
					  <div class="col-sm-3">
                        <input type="text" class="validate[required,custom[number]] form-control" name="bayil" value="<?php echo $r[bayil];?>"placeholder="Laki-Laki">
                      </div>
					</div>
				...
				<div class="form-group">  
					 <label for="bayip" class="col-sm-4 control-label">Perempuan <span class="text-danger"> *</span></label>
					  <div class="col-sm-3">
                        <input type="text" class="validate[required,custom[number]] form-control" name="bayip" value="<?php echo $r[bayip];?>"placeholder="Perempuan">
                      </div>
					</div>
					...
					<div class="form-group">  
					 <label for="meninggalbayil" class="col-sm-4 control-label">Laki-Laki <span class="text-danger"> *</span></label>
					  <div class="col-sm-3">
                        <input type="text" class="validate[required,custom[number]] form-control" name="meninggalbayil" value="<?php echo $r[meninggalbayil];?>"placeholder="Laki-Laki">
                      </div>
					</div>
				...
				<div class="form-group">  
					 <label for="meninggalbayip" class="col-sm-4 control-label">Perempuan <span class="text-danger"> *</span></label>
					  <div class="col-sm-3">
                        <input type="text" class="validate[required,custom[number]] form-control" name="meninggalbayip" value="<?php echo $r[meninggalbayip];?>"placeholder="Perempuan">
                      </div>
					</div>
