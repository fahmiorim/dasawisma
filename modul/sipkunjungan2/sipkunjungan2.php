...
<script>
    $(document).on('click', '.pilih1', function(e) {
        document.getElementById("kodekel").value = $(this).attr('data-kode');
        document.getElementById("kelurahan").value = $(this).attr('data-nama_kel');
        document.getElementById("kodekec").value = $(this).attr('data-kodekec');
        document.getElementById("kecamatan").value = $(this).attr('data-nama_kec');
        $('#myModal1').modal('hide');
    });
</script>
...
if (empty($_SESSION['ses_user']) AND empty($_SESSION['ses_password'])){  
  ...
  $total_pages = ceil($count / $limit);
	...
	echo"
          ...
          <a  class="btn bg-purple margin" data-toggle="tooltip" data-placement="top" title="Tambah" href="?module=sipkunjungan2&act=tambahsipkunjungan"><i class="fa fa-send"></i> Tambah</a> 
		  
		<?php
		if($count > 0)
        {
		?>			 
			 <button class="btn bg-orange btn-flat margin"  data-toggle="tooltip" data-placement="top" title="lihat"  onClick="view_records_sipkunjungan2();" ><i class="fa fa-desktop"></i> Lihat</button>
		  <button class="btn bg-olive btn-flat margin" data-toggle="tooltip" data-placement="top" title="Edit"  onClick="update_records_sipkunjungan2();" ><i class="fa fa-edit"></i> Edit</button> 
		  <button class="btn btn-danger" data-toggle="tooltip" data-placement="top" title="Hapus"   onClick="delete_records_sipkunjungan2();" ><i class="fa fa-remove"></i> Hapus </button>
		  </div>
		...
		<?php } ?>	
				...
				<div class="box-body table-responsive no-padding">
                  <table id='example1' class='table table-bordered table-striped'>
					...
					<?php  
					$no = $offset + 1;
					$lingk =pg_query($koneksi, "select * from sipkunjungan LIMIT $limit OFFSET $offset");
			...
			?>
              ...
              ?> 
                ...
                <div class='box-footer'>
                  <ul class='pagination'>
                    <?php if($page > 1): ?>
                      <li><a href='?module=sipkunjungan2&page=<?php echo $page - 1; ?>'>&laquo; Prev</a></li>
                    <?php endif; ?>
                    
                    <?php for($i = 1; $i <= $total_pages; $i++): ?>
                      <li class='<?php echo $i == $page ? 'active' : ''; ?>'>
                        <a href='?module=sipkunjungan2&page=<?php echo $i; ?>'><?php echo $i; ?></a>
                      </li>
                    <?php endfor; ?>
                    
                    <?php if($page < $total_pages): ?>
                      <li><a href='?module=sipkunjungan2&page=<?php echo $page + 1; ?>'>Next &raquo;</a></li>
                    <?php endif; ?>
                  </ul>
	...
	<?php		  
	 ...
	 <center><h3 class="box-title">DATA JUMLAH PENGUNJUNG/PETUGAS POSYANDU</h3></center>
			...
			<div class="box box-info">
                ...
                <form class="form-horizontal" action="<?php echo $aksi;?>?module=sipkunjungan2&act=input" name="sipkunjungan2" method="POST" id="popup-validation" enctype="multipart/form-data">
				<div class="col-md-6">
                  <div class="box-body">
		...
		<div class="modal fade" id="myModal14" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
            <div class="modal-dialog" style="width:1000px">
				...
				<div class="col-md-12">	
                  <div class="box-footer">
                    <a type="submit"  href="appmaster.php?module=sipkunjungan2" class="btn btn-danger"><i class="fa fa-remove"></i> Cancel</a>
