...
if(isset($_POST['chk'])=="")
{
    ...
    <script>
       ...
       window.location.href = 'appmaster.php?module=warung';
    </script>
    <?php
}
$chk = $_POST['chk'];
...
?>
     <center><h3 class="box-title">EDIT DATA WARUNG PKK</h3></center>
   ...
   <form method="POST" class="form-horizontal" enctype="multipart/form-data" action="<?php echo $aksi;?>?module=warung&act=update"id="popup-validation">
	<?php
        ...
        <input type="hidden" name="id" value="<?php echo $r['id'];?>" />
				<div class="col-md-6">
                   ...
                   <div class="form-group">
					  ...
					  <div class="col-sm-8">
                        <input type="text" class="validate[required] form-control" name="namawarung" placeholder="Nama Warung" value="<?php echo $r[namawarung];?>">
                       </div>
					 </div>
					...
					<div class="form-group">
					  ...
					  <div class="col-sm-7">
                        <input type="text" class="validate[required] form-control" name="pengelola" id="pengelola" placeholder="Pengelola"value="<?php echo $r[pengelola];?>">
                       </div>
					 </div>
				...
				<div class="col-md-6">
					...
					<label for="kategori" class="col-sm-4 control-label">Kategori<span class="text-danger"> *</span></label>
					  <div class="col-sm-7">
					    <input type="text" class="validate[required] form-control" name="kategori" placeholder="Kategori" value="<?php echo $r[kategori];?>">
                     </div>
					 </div>
					...
					<label for="Volume" class="col-sm-4 control-label">Volume<span class="text-danger"> *</span></label>
					  <div class="col-sm-3">
					    <input type="text" class="validate[required,custom[number]] form-control" name="volume" value="<?php echo $r[volume];?>"placeholder="Volume">
                     </div>
					 </div>
        ...
        <div class="form-group">
               <div class="col-sm-offset-2 col-sm-5">
                <button class="btn bg-purple btn-flat margin"  name="cmdeditwarung" title="Edit" ><i class="fa fa-pencil"></i>
                   Edit
                </button>
