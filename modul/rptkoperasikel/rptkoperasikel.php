...
if (empty($_SESSION['ses_user']) and empty($_SESSION['ses_password'])) {
	...
	switch ($act) {
		default:
			$koperasi = pg_query($koneksi, "select * from koperasi where kodekel='$_SESSION[ses_kodekel]'");
			$count = pg_num_rows($koperasi);
			echo "
			
				<div class='box'>
                <div class='box-header'>
                  <h2 class='box-title'>Laporan Data Koperasi PKK Per Desa/Kelurahan</h2>";
?>
			<form method="post" name="frm">
				...
				<div style="text-align:right">
					...
					<button class="btn bg-purple btn-flat margin" data-toggle="tooltip" data-placement="top" title="Print Koperasi PKK" onClick="print_records_rptkoperasikel();"><i class="fa fa-print"></i> Print Koperasi PKK</button>
