...
if(isset($_POST['chk'])=="")
{
    ...
    <script>
       ...
       window.location.href = 'appmaster.php?module=kejarpaket2';
    </script>
    <?php
}
$chk = $_POST['chk'];
...
?>
     <center><h3 class="box-title">EDIT DATA KEJAR PAKET/KF/PAUD</h3></center>
   ...
   <form method="POST" class="form-horizontal" enctype="multipart/form-data" action="<?php echo $aksi;?>?module=kejarpaket2&act=update"id="popup-validation">
	<?php
        ...
        <input type="hidden" name="id" value="<?php echo $r['id'];?>" />
				  ...
				  <div class="form-group">
					...
					<div class="form-group">	
					 ...
					 <div class="form-group">
					  ...
					  <div class="col-sm-8">
                        <input type="text" class="validate[required] form-control" name="namapaket" id="namapaket" placeholder="Nama Kejar Paket/KF/PAUD" value="<?php echo $r[namapaket];?>">
                       </div>
					 </div>
				...
				<div class="col-md-6">
					...
					<label for="anggotalk" class="col-sm-4 control-label">Laki-Laki<span class="text-danger"> *</span></label>
					  <div class="col-sm-3">
					    <input type="text" class="validate[required,custom[number]] form-control" name="waberlk" id="waberlk" placeholder="Laki-Laki" value="<?php echo $r[waberlk];?>">
                     </div>
					 </div>
					...
					<label for="waberpr" class="col-sm-4 control-label">Perempuan<span class="text-danger"> *</span></label>
					  <div class="col-sm-3">
					    <input type="text" class="validate[required,custom[number]] form-control" name="waberpr" id="waberpr" placeholder="Perempuan" value="<?php echo $r[waberpr];?>">
                     </div>
					 </div>
					...
					<label for="pengajarlk" class="col-sm-4 control-label">Laki-Laki<span class="text-danger"> *</span></label>
					  <div class="col-sm-3">
					    <input type="text" class="validate[required,custom[number]] form-control" name="pengajarlk" id="pengajarlk" placeholder="Laki-Laki" value="<?php echo $r[pengajarlk];?>">
                     </div>
					 </div>
					...
					<label for="pengajarpr" class="col-sm-4 control-label">Perempuan<span class="text-danger"> *</span></label>
					  <div class="col-sm-3">
					    <input type="text" class="validate[required,custom[number]] form-control" name="pengajarpr" id="pengajarpr" placeholder="Perempuan"value="<?php echo $r[pengajarpr];?>">
                     </div>
					 </div>
        ...
        <div class="form-group">
               <div class="col-sm-offset-2 col-sm-5">
                <button class="btn bg-purple btn-flat margin"  name="cmdeditkejarpaket" title="Edit" ><i class="fa fa-pencil"></i>
                   Edit
                </button>
