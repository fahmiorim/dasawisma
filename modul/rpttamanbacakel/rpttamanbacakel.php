...
if (empty($_SESSION['ses_user']) and empty($_SESSION['ses_password'])) {
	...
	switch ($act) {
		default:
			$tamanbaca = pg_query($koneksi, "select * from tamanbaca where kodekel='$_SESSION[ses_kodekel]'");
			$count = pg_num_rows($tamanbaca);
			echo "
			
				<div class='box'>
                <div class='box-header'>
                  <h2 class='box-title'>Laporan Data Taman Baca PKK Per Desa/Kelurahan</h2>";
?>
			<form method="post" name="frm">
				...
				<div style="text-align:right">
					...
					<button class="btn bg-purple btn-flat margin" data-toggle="tooltip" data-placement="top" title="Print Taman Baca PKK" onClick="print_records_rpttamanbacakel();"><i class="fa fa-print"></i> Print Taman Baca PKK</button>
