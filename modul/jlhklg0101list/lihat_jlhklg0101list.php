...
if(isset($_POST['chk'])=="")
{
    ...
    <script>
       ...
       window.location.href = 'appmaster.php?module=jlhklg0101list';
    </script>
    <?php
}
$chk = $_POST['chk'];
...
?>
   ...
   <form method="POST" class="form-horizontal" enctype="multipart/form-data" action="<?php echo $aksi;?>?module=jlhklg0101list"id="popup-validation">
	<?php
