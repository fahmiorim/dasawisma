...
if(isset($_POST['chk'])=="")
{
    ...
    <script>
       ...
       window.location.href = 'appmaster.php?module=saranamck2';
    </script>
    <?php
}
$chk = $_POST['chk'];
...
?>
     <center><h3 class="box-title">EDIT DATA SARANA MCK</h3></center>
   ...
   <form method="POST" class="form-horizontal" enctype="multipart/form-data" action="<?php echo $aksi;?>?module=saranamck2&act=update"id="popup-validation">
	<?php
		for($i=0; $i<$chkcount; $i++)
		{
			$id = $chk[$i];
			$res=pg_query($koneksi, "select * from saranamck where id=".$id);
        ...
        <input type="hidden" name="id" value="<?php echo $r['id'];?>" />
				...
				<div class="col-md-6">
					...
					<label for="jlhpintu" class="col-sm-4 control-label">Jumlah Pintu<span class="text-danger"> *</span></label>
					  <div class="col-sm-3">
					    <input type="text" class="validate[required,custom[number]] form-control" name="jlhpintu" id="jlhpintu" placeholder="Jumlah Pintu" value="<?php echo $r[jlhpintu];?>">
                     </div>
				</div>
					...
					<label for="saranalain" class="col-sm-4 control-label">Sarana Lain<span class="text-danger"> *</span></label>
					  <div class="col-sm-7">
					    <input type="text" class="validate[required] form-control" name="saranalain" id="saranalain" placeholder="sarana lain" value="<?php echo $r[saranalain];?>">
                     </div>
					</div>
        ...
        <div class="form-group">
               <div class="col-sm-offset-2 col-sm-5">
                <button class="btn bg-purple btn-flat margin"  name="cmdeditsaranamck" title="Edit" ><i class="fa fa-pencil"></i>
                   Edit
                </button>
