...
?>
     <center><h3 class="box-title">LIHAT DATA SARANA MCK</h3></center>
   ...
   <form method="POST" class="form-horizontal" enctype="multipart/form-data" action="<?php echo $aksi;?>?module=saranamck2"id="popup-validation">
	<?php
        ...
        <input type="hidden" name="id" value="<?php echo $r['id'];?>" />
				...
				<div class="col-md-6">
					...
					<label for="jlhpintu" class="col-sm-4 control-label">Jumlah Pintu<span class="text-danger"> *</span></label>
					  <div class="col-sm-3">
					    <input type="text" class="validate[required,custom[number]] form-control" name="jlhpintu" id="jlhpintu" placeholder="Jumlah Pintu" value="<?php echo $r[jlhpintu];?>" readonly>
                     </div>
				</div>
					...
					<label for="saranalain" class="col-sm-4 control-label">Sarana Lain<span class="text-danger"> *</span></label>
					  <div class="col-sm-7">
					    <input type="text" class="validate[required] form-control" name="saranalain" id="saranalain" placeholder="sarana lain" value="<?php echo $r[saranalain];?>" readonly>
                     </div>
					</div>
