...
?>
     <center><h3 class="box-title">LIHAT DATA KOPERASI PKK</h3></center>
   ...
   <form method="POST" class="form-horizontal" enctype="multipart/form-data" action="<?php echo $aksi;?>?module=koperasi"id="popup-validation">
	<?php
