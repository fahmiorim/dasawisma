...
if(isset($_POST['chk'])=="")
{
    ...
    <script>
       ...
       window.location.href = 'appmaster.php?module=jlhagt0306list';
    </script>
    <?php
}
$chk = $_POST['chk'];
...
?>
     <center><h3 class="box-title">LIHAT CATATAN KELUARGA KELURAHAN DATARAN TINGGI KOTA BINJAI</h3></center>
   ...
   <form method="POST" class="form-horizontal" enctype="multipart/form-data" action="<?php echo $aksi;?>?module=jlhagt0306list"id="popup-validation">
	<?php
