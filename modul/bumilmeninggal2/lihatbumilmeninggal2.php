...
if(isset($_POST['chk'])=="")
{
    ...
    <script>
       ...
       window.location.href = 'appmaster.php?module=bumilmeninggal2';
    </script>
    <?php
}
$chk = $_POST['chk'];
...
?>
     <center><h3 class="box-title">LIHAT DATA IBU HAMIL/BALITA MENINGGAL</h3></center>
   ...
   <form method="POST" class="form-horizontal" enctype="multipart/form-data" action="<?php echo $aksi;?>?module=bumilmeninggal2"id="popup-validation">
	<?php
        ...
        <input type="hidden" name="id" value="<?php echo $r['id'];?>" />
				<div class="col-md-6">
                   ...
                   <div class="form-group">
					...
					<div class="form-group">
					  <label for="nama" class="col-sm-4 control-label">Nama Ibu/Bayi/Balita<span class="text-danger"> *</span></label>
					  <div class="col-sm-7">
                        <input type="text" class="validate[required] form-control" name="nama" id="nama" placeholder="Nama Ibu/Bayi/Balita" value="<?php echo $r[nama];?>" readonly>
                       </div>
					 </div>
				...
				<div class="col-md-6">
					...
					<div class="form-group">
					  ...
					  <div class="col-sm-7">
                        <input type="text" class="form-control" name="namabayi" placeholder="Nama Bayi/Balita" value="<?php echo $r[namabayi];?>" readonly>
                       </div>
					 </div>
					...
					<div class="form-group">
					 ...
					 <div class="form-group">
                      ...
                      <div class="col-sm-4">
                        <input type="text" class="validate[required,custom[date]] form-control" id="tglmeninggal" name="tglmeninggal" placeholder="YYYY-MM-DD" value="<?php echo $r[tglmeninggal];?>" readonly>
                      </div>
					</div>
					 ...
					 <div class="form-group">
                      ...
                      <div class="col-sm-7">
                        <input type="text" class="validate[required] form-control" id="sebabmeninggal" name="sebabmeninggal" placeholder="Sebab Meninggal" value="<?php echo $r[sebabmeninggal];?>" readonly>
                      </div>
					</div>
					...
					<div class="form-group">
                      ...
                      <div class="col-sm-7">
                        <input type="text" class="form-control" name="keterangan" placeholder="Keterangan" value="<?php echo $r[keterangan];?>" readonly>
                      </div>
					</div>
