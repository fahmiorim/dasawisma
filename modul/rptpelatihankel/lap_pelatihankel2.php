...
header("Content-Disposition: attachment; filename=Rpt_PelatihanKel.xls");
...
<table width="1974" border="0">
	...
	<tr>
		<td align="center"><span class="style1">LAPORAN DATA PELATIHAN DESA/KELURAHAN <?php echo $namakel; ?></span></td>
	</tr>
	...
	<tr>
		<td>
			<table width="1968" border="1" cellpadding="0" cellspacing="0" class="table table-bordered table-striped">
				...
				$no = 1;
				$tim = pg_query($koneksi, "select * from pelatihan where kodekel='$_GET[kdkel]' order by lingkungan ");
