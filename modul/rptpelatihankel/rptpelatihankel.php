...
if (empty($_SESSION['ses_user']) and empty($_SESSION['ses_password'])) {
	...
	switch ($act) {
		default:
			$datads = pg_query($koneksi, "select * from pelatihan where kodekel='$_SESSION[ses_kodekel]'");
			$count = pg_num_rows($datads);
			echo "
			
				<div class='box'>
                <div class='box-header'>
                  <h2 class='box-title'>Laporan Data Pelatihan $namakel</h2>";
?>
			<form method="post" name="frm">
				...
				<div style="text-align:right">
					...
					?>
						...
						<button class="btn bg-purple btn-flat margin" data-toggle="tooltip" data-placement="top" title="Print Per Kelurahan" onClick="print_records_rptpelatihankel();"><i class="fa fa-print"></i> Print Data Pelatihan</button>
