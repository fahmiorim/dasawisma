...
?>
     <center><h3 class="box-title">Edit Data Komoditi</h3></center>
   ...
   <form method="POST" class="form-horizontal" enctype="multipart/form-data" action="<?php echo $aksi;?>?module=mstkomoditi&act=update"id="popup-validation">
	<?php
