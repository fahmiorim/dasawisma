...
if(isset($_POST['chk'])=="")
{
    ...
    <script>
       ...
       window.location.href = 'appmaster.php?module=penyuluhan2';
    </script>
    <?php
}
$chk = $_POST['chk'];
...
?>
     <center><h3 class="box-title">LIHAT DATA PENYULUHAN</h3></center>
   ...
   <form method="POST" class="form-horizontal" enctype="multipart/form-data" action="<?php echo $aksi;?>?module=penyuluhan2"id="popup-validation">
	<?php
		for($i=0; $i<$chkcount; $i++)
		{
			$id = $chk[$i];
			$res=pg_query($koneksi, "select * from penyuluhan where id=".$id);
        ...
        <input type="hidden" name="id" value="<?php echo $r['id'];?>" />
				<div class="col-md-6">
				  ...
				  <div class="form-group">
					<label for="kegiatan" class="col-sm-4 control-label">Nama Kegiatan<span class="text-danger"> *</span></label>
					  <div class="col-sm-7">
					    <input type="text" class="validate[required] form-control" name="kegiatan" id="kegiatan" placeholder="Nama Kegiatan"value="<?php echo $r[kegiatan];?>"readonly>
                     </div>
					</div>
					...
					<div class="form-group">
					 <label for="namapenyuluhan" class="col-sm-4 control-label">Jenis Penyuluhan<span class="text-danger"> *</span></label>
					  <div class="col-sm-7">
                        <select class=" validate[required] form-control" name='namapenyuluhan' id='namapenyuluhan'readonly >
							<option><?php echo $r[namapenyuluhan];?></option>
				...
				<div class="col-md-6">
					...
					<label for="jlhkelompok" class="col-sm-4 control-label">Jumlah Kelompok<span class="text-danger"> *</span></label>
					  <div class="col-sm-3">
					    <input type="text" class="validate[required,custom[number]] form-control" name="jlhkelompok" id="jlhkelompok" placeholder="Jumlah Kelompok"value="<?php echo $r[jlhkelompok];?>"readonly>
                     </div>
				</div>
				...
				<div class="form-group">
					<label for="jlhpenyuluh" class="col-sm-4 control-label">Jumlah Penyuluhan<span class="text-danger">*</span></label>
					  <div class="col-sm-3">
					    <input type="text" class="validate[required,custom[number]] form-control" name="jlhpenyuluh" id="jlhpenyuluh" placeholder="Jumlah Penyuluhan"value="<?php echo $r[jlhpenyuluh];?>"readonly>
                     </div>
				</div>
				...
				<div class="form-group">
					<label for="kaderlk" class="col-sm-4 control-label">Laki-Laki<span class="text-danger">*</span></label>
					  <div class="col-sm-3">
					    <input type="text" class="validate[required,custom[number]] form-control" name="kaderlk" id="kaderlk" placeholder="Laki-Laki"value="<?php echo $r[kaderlk];?>"readonly>
                     </div>
				</div>
				...
				<div class="form-group">
					<label for="kaderpr" class="col-sm-4 control-label">Perempuan<span class="text-danger">*</span></label>
					  <div class="col-sm-3">
					    <input type="text" class="validate[required,custom[number]] form-control" name="kaderpr" id="kaderpr" placeholder="Perempuan"value="<?php echo $r[kaderpr];?>"readonly>
                     </div>
				</div>
