...
?>
     <center><h3 class="box-title">EDIT DATA PENYULUHAN</h3></center>
   ...
   <form method="POST" class="form-horizontal" enctype="multipart/form-data" action="<?php echo $aksi;?>?module=penyuluhan2&act=update"id="popup-validation">
	<?php
        ...
        <input type="hidden" name="id" value="<?php echo $r['id'];?>" />
				<div class="col-md-6">
				  ...
				  <div class="form-group">
					<label for="kegiatan" class="col-sm-4 control-label">Nama Kegiatan<span class="text-danger"> *</span></label>
					  <div class="col-sm-7">
					    <input type="text" class="validate[required] form-control" name="kegiatan" id="kegiatan" placeholder="Nama Kegiatan"value="<?php echo $r[kegiatan];?>">
                     </div>
					</div>
				...
				<div class="form-group">
					<label for="jlhpenyuluh" class="col-sm-4 control-label">Jumlah Penyuluhan<span class="text-danger">*</span></label>
					  <div class="col-sm-3">
					    <input type="text" class="validate[required,custom[number]] form-control" name="jlhpenyuluh" id="jlhpenyuluh" placeholder="Jumlah Penyuluhan"value="<?php echo $r[jlhpenyuluh];?>">
                     </div>
				</div>
				...
				<div class="form-group">
					<label for="kaderlk" class="col-sm-4 control-label">Laki-Laki<span class="text-danger">*</span></label>
					  <div class="col-sm-3">
					    <input type="text" class="validate[required,custom[number]] form-control" name="kaderlk" id="kaderlk" placeholder="Laki-Laki"value="<?php echo $r[kaderlk];?>">
                     </div>
				</div>
				...
				<div class="form-group">
					<label for="kaderpr" class="col-sm-4 control-label">Perempuan<span class="text-danger">*</span></label>
					  <div class="col-sm-3">
					    <input type="text" class="validate[required,custom[number]] form-control" name="kaderpr" id="kaderpr" placeholder="Perempuan"value="<?php echo $r[kaderpr];?>">
                     </div>
				</div>
        ...
        <div class="form-group">
               <div class="col-sm-offset-2 col-sm-5">
                <button class="btn bg-purple btn-flat margin"  name="cmdeditpenyuluhan" title="Edit" ><i class="fa fa-pencil"></i>
                   Edit
                </button>
