...
if(isset($_POST['chk'])=="")
{
    ...
    <script>
       ...
       window.location.href = 'appmaster.php?module=pekarangan2';
    </script>
    <?php
}
$chk = $_POST['chk'];
...
?>
     <center><h3 class="box-title">LIHAT DATA PEMANFAATAN TANAH PERKARANGAN</h3></center>
   ...
   <form method="POST" class="form-horizontal" enctype="multipart/form-data" action="<?php echo $aksi;?>?module=pekarangan2"id="popup-validation">
	<?php
		for($i=0; $i<$chkcount; $i++)
		{
			$id = $chk[$i];
			$res=pg_query($koneksi, "select * from pekarangan where id=".$id);
				...
				<div class="col-md-6">
					...
					<div class="form-group">
					 <label for="kategori" class="col-sm-4 control-label">Kategori<span class="text-danger"> *</span></label>
					  <div class="col-sm-7">
                        <select class=" validate[required] form-control" name='kategori' readonly >
					...
					<label for="komoditi" class="col-sm-4 control-label">Komoditi<span class="text-danger"> *</span></label>
					  <div class="col-sm-7">
					    <input type="text" class="validate[required] form-control" name="komoditi" id="komoditi" placeholder="Komoditi" value="<?php echo $r[komoditi];?>"readonly>
                     </div>
					 </div>
					...
					<label for="jumlah" class="col-sm-4 control-label">Jumlah<span class="text-danger"> *</span></label>
					  <div class="col-sm-3">
					    <input type="text" class="validate[required,custom[number]] form-control" name="jumlah" id="jumlah" value="<?php echo $r[jumlah];?>" placeholder="Jumlah"readonly>
                     </div>
					 </div>
