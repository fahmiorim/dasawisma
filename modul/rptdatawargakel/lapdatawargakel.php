						...
						<div class="box-body table-responsive no-padding">
							<table id='example1' class='table table-bordered table-striped'>
								<script type="text/javascript">
									...
									function popup() {
										window.open('modul/rptdatawargakel/lap_datawargakel.php?kdkel=<?php echo $kodekelurahan; ?>')
									}
								</script>
								...
								<script type="text/javascript">
									...
									function popup2() {
										window.open('modul/rptdatawargakel/lap_datawargakel2.php?kdkel=<?php echo $kodekelurahan; ?>')
									}
								</script>
								...
								<div style="text-align:right">
									<a class="btn bg-green margin" data-toggle="tooltip" data-placement="top" title="Kembali" href="?module=rptdatawargakel"><i class="fa fa-send"></i> Kembali</a>
								...
								<tbody>
									...
									$dasa = pg_query($koneksi, "select * from datawarga where kodekel='$_SESSION[ses_kodekel]' order by nokk");
									...
									?>
										<tr>
											...
											<td><?php echo " $ds[alamat_domisili]"; ?></td>
											<td><?php echo " $ds[alamat_ktp]"; ?></td>
