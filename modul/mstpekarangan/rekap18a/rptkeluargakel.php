...
if (empty($_SESSION['ses_user']) AND empty($_SESSION['ses_password'])){  
  ...
  switch($act){
    default:
	 $datads = pg_query($koneksi, "select * from keluarga where kodekel='$_SESSION[ses_kodekel]'");
  $count=pg_num_rows($datads);
	echo"
			
				<div class='box'>
                <div class='box-header'>
                  <h2 class='box-title'>Laporan Data Catatan Keluarga Per Kelurahan</h2>";
                ?>
		...
		?>			
				 ...
				 <div class="form-group">
					<label for="kodekel" class="col-sm-1 control-label">Kelurahan</label>
                      <div class="col-sm-2">
				...
				<button class="btn bg-purple btn-flat margin"  data-toggle="tooltip" data-placement="top" title="Print Per Kelurahan"  onClick="print_records_rptkeluargakel();" ><i class="fa fa-print"></i> Print Per Kelurahan</button>
		...
		<?php } ?>	
				...
				<div class="box-body table-responsive no-padding">
                  <table id='example1' class='table table-bordered table-striped'>
					...
					$dasa =pg_query($koneksi, "select * from keluarga where kodekel='$_SESSION[ses_kodekel]' order by lingkungan,dasawisma");
