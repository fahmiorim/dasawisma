...
if (empty($_SESSION['ses_user']) and empty($_SESSION['ses_password'])) {
	...
	<div class='box'>
                <div class='box-header'>
                  <h2 class='box-title'>Laporan Posyandu</h2>";
						...
						<div class="box-body table-responsive no-padding">
							<table id='example1' class='table table-bordered table-striped'>
								<script type="text/javascript">
									...
									function popup() {
										window.open('modul/rptposyandukel/lap_posyandukel.php?kdkel=<?php echo $kodekelurahan; ?>')
									}
								</script>
								...
								<script type="text/javascript">
									...
									function popup2() {
										window.open('modul/rptposyandukel/lap_posyandukel2.php?kdkel=<?php echo $kodekelurahan; ?>')
									}
								</script>
								...
								<div style="text-align:right">
									<a class="btn bg-green margin" data-toggle="tooltip" data-placement="top" title="Kembali" href="?module=rptposyandukel"><i class="fa fa-send"></i> Kembali</a>
								...
								<tbody>
									...
									$dasa = pg_query($koneksi, "select * from posyandu where kodekel='$_SESSION[ses_kodekel]' order by lingkungan");
