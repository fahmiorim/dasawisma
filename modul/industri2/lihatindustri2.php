...
if(isset($_POST['chk'])=="")
{
    ...
    <script>
       ...
       window.location.href = 'appmaster.php?module=industri2';
    </script>
    <?php
}
$chk = $_POST['chk'];
...
?>
     <center><h3 class="box-title">LIHAT DATA INDUSTRI RUMAH TANGGA</h3></center>
   ...
   <form method="POST" class="form-horizontal" enctype="multipart/form-data" action="<?php echo $aksi;?>?module=industri2"id="popup-validation">
	<?php
				...
				<div class="col-md-6">
					...
					<div class="form-group">
					 <label for="satuan" class="col-sm-4 control-label">Satuan<span class="text-danger"> *</span></label>
					  <div class="col-sm-4">
                        <select class=" validate[required] form-control" name='satuan' id='satuan' readonly >
