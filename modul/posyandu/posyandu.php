...
if (empty($_SESSION['ses_user']) AND empty($_SESSION['ses_password'])){  
  header('location:404.php');
	...
	$aksi = "modul/posyandu/aksi_posyandu.php";
  ...
  $count=pg_num_rows($kec);
	...
	<div class='box'>
                <div class='box-header'>
                  <h2 class='box-title'>DATA PROFIL POSYANDU</h2>";
                ?>
        ...
        {
		?>			 
			 <button class="btn bg-orange btn-flat margin"  data-toggle="tooltip" data-placement="top" title="lihat"  onClick="view_records_posyandu();" ><i class="fa fa-desktop"></i> Lihat</button>
		  <button class="btn bg-olive btn-flat margin" data-toggle="tooltip" data-placement="top" title="Edit"  onClick="update_records_posyandu();" ><i class="fa fa-edit"></i> Edit</button> 
		  <button class="btn btn-danger" data-toggle="tooltip" data-placement="top" title="Hapus"   onClick="delete_records_posyandu();" ><i class="fa fa-remove"></i> Hapus </button>
		  </div>
		...
		<?php } ?>	
				...
				<div class="box-body table-responsive no-padding">
                  <table id='example1' class='table table-bordered table-striped'>
					...
					<?php  
					$no = 1;
					$lingk =pg_query($koneksi, "select * from posyandu where kodekel='$_SESSION[ses_kodekel]' order by lingkungan");
	...
	<?php		  
	 break;
	  ...
	  $rand4 = randpass4(3);
	 ?>
	 <center><h3 class="box-title">TAMBAH DATA PROFIL POSYANDU</h3></center>
