...
header("Content-Disposition: attachment; filename=Rpt_KoperasiKota.xls");
...
<input type="hidden" name="id" value="<?php echo $r['id'];?>" />
  <tr>
    <td align="center"><span class="style4">LAPORAN KOPERASI PKK SE-KABUPATEN BATU BARA</span></td>
  </tr>
  ...
  <tr>
    <td><table width="977" border="1" cellpadding="0" cellspacing="0" class="table table-bordered table-striped">
	  ...
	  <?php
					...
					$no = 1;
					$tim =pg_query($koneksi, "select * from koperasi order by lingkungan ");
