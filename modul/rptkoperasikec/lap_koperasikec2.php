...
header("Content-Disposition: attachment; filename=Rpt_KoperasiKec.xls");
...
<input type="hidden" name="id" value="<?php echo $r['id'];?>" />
  <tr>
    <td align="center"><span class="style4">LAPORAN KOPERASI PKK KECAMATAN <?php echo $namakec; ?></span></td>
  </tr>
  ...
  <tr>
    <td><table width="977" border="1" cellpadding="0" cellspacing="0" class="table table-bordered table-striped">
      <tr>
	  					
					<td width="42"  align="center">No</td>
					<td width="141"  align="center">kecurahan</td>
	  ...
	  <?php
					...
					$no = 1;
					$tim =pg_query($koneksi, "select * from koperasi where kodekec='$_GET[kdkec]' order by lingkungan ");
					while ($tm=pg_fetch_array($tim)){       
	  ?>
      <tr>
						<td><?php echo" $no"; ?></td>
                         <td><?php echo" $tm[kecurahan]"; ?></td>
