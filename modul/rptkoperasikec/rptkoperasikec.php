...
if (empty($_SESSION['ses_user']) AND empty($_SESSION['ses_password'])){  
  ...
  switch($act){
    default:
	 $koperasi = pg_query($koneksi, "select * from koperasi where kodekec='$_SESSION[ses_kodekec]'");
  $count=pg_num_rows($koperasi);
	echo"
			
				<div class='box'>
                <div class='box-header'>
                  <h2 class='box-title'>Laporan Data Koperasi PKK Kecamatan $namakec</h2>";
                ?>
		 ...
		 <button class="btn bg-purple btn-flat margin"  data-toggle="tooltip" data-placement="top" title="Print Koperasi PKK"  onClick="print_records_rptkoperasikec();" ><i class="fa fa-print"></i> Print Koperasi PKK</button>
