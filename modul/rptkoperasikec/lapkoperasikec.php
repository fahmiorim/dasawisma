  ...
  $count=pg_num_rows($dswisma);
	...
	<div class='box'>
                <div class='box-header'>
                  <h2 class='box-title'>Laporan Koperasi PKK Kecamatan $namakec</h2>";
		...
		<?php } ?>	
				...
				<div class="box-body table-responsive no-padding">
                  <table id='example1' class='table table-bordered table-striped'>
							<script type="text/javascript">
								...
								function popup() {
								window.open('modul/rptkoperasikec/lap_koperasikec.php?kdkec=<?php echo $kodekecamatan;?>')
								}
							</script>
							...
							<script type="text/javascript">
								var s5_taf_parent = window.location;
								function popup2() {
								window.open('modul/rptkoperasikec/lap_koperasikec2.php?kdkec=<?php echo $kodekecamatan;?>')
								}
							</script>
				...
				<div class="form-group">
					<label for="nmkec" class="col-sm-1 control-label">Nama</label>
                      <div class="col-sm-3">
						...
						<input type="text" class="form-control" id="nmkec" name="nmkec" placeholder="Nama Kecamatan" value="<?php echo "$_SESSION[ses_namakec]";?>" readonly>
								...
								<div style="text-align:right">	
								 <a  class="btn bg-green margin"  data-toggle="tooltip" data-placement="top" title="Kembali" href="?module=rptkoperasikec"><i class="fa fa-send"></i> Kembali</a>
					...
					$dasa =pg_query($koneksi, "select * from koperasi where kodekec='$_SESSION[ses_kodekec]' order by lingkungan");
