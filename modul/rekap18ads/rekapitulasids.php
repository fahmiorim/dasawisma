      ...
      <form method="post" name="frm">
        ...
        ?>
          ...
          <div class="form-group">
            <div class="col-sm-3">
              <br>
              <button class="btn bg-green" data-toggle="tooltip" data-placement="top" title="Cetak" onClick="print_records_rekap18ads();"><i class="fa fa-eye"></i> Print Rekapitulasi</button>
            </div>
          </div>
