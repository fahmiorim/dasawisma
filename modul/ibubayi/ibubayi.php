...
if (empty($_SESSION['ses_user']) and empty($_SESSION['ses_password'])) {
	...
	switch ($act) {
		default:
			$kec = pg_query($koneksi, "SELECT * FROM ibubayi order by namaibu");
			$count = pg_num_rows($kec);
			echo "
	
	<div class='box'>
                <div class='box-header'>
                  <h2 class='box-title'>DATA IBU HAMIL, MELAHIRKAN, NIFAS, IBU MENINGGAL*, KELAHIRAN BAYI, BAYI MENINGGAL DAN KEMATIAN BALITA</h2>";
?>
			<form method="post" name="frm">
				...
				<div style="text-align:right">
					...
					<a class="btn bg-purple margin" data-toggle="tooltip" data-placement="top" title="Tambah" href="?module=ibubayi&act=tambahibubayi"><i class="fa fa-send"></i> Tambah</a>

					<?php
					if ($count > 0) {
					?>
						<button class="btn bg-orange btn-flat margin" data-toggle="tooltip" data-placement="top" title="lihat" onClick="view_records_ibubayi();"><i class="fa fa-desktop"></i> Lihat</button>
						<button class="btn bg-olive btn-flat margin" data-toggle="tooltip" data-placement="top" title="Edit" onClick="update_records_ibubayi();"><i class="fa fa-edit"></i> Edit</button>
						<button class="btn btn-danger" data-toggle="tooltip" data-placement="top" title="Hapus" onClick="delete_records_ibubayi();"><i class="fa fa-remove"></i> Hapus </button>
				</div>
				...
				<div class="box-body table-responsive no-padding">
					<table id='example1' class='table table-bordered table-striped'>
						...
						<tbody>
							<?php
							$no = 1;
							$lingk = pg_query($koneksi, "select * from ibubayi where kodekel='$_SESSION[ses_kodekel]' order by namaibu");
		...
		?>
			<center>
				<h3 class="box-title">TAMBAH DATA IBU/BALITA/BAYI</h3>
			</center>
				...
				<form class="form-horizontal" action="<?php echo $aksi; ?>?module=ibubayi&act=input" method="POST" id="popup-validation" enctype="multipart/form-data">
					...
					<div class="col-md-6">
						<div class="box-body">
							...
							<div class="form-group">
								<label for="tglmelahirkan" class="col-sm-4 control-label">Tgl Melahirkan</span></label>
								<div class="col-sm-4">
									<input type="text" class="form-control" id="tglmelahirkan" name="tglmelahirkan" placeholder="YYYY-MM-DD" value="<?php echo "$tgl_kosong"; ?>">
								</div>
							</div>
							...
							<div class="form-group">
								...
								<div class="col-sm-4">
									<input type="text" class="form-control" id="tglmeninggal" name="tglmeninggal" placeholder="YYYY-MM-DD" value="<?php echo "$tgl_kosong"; ?>">
								</div>
							</div>
