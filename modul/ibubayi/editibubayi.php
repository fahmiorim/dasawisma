...
?>
			...
			?>
			<center>
				<h3 class="box-title">EDIT DATA IBU MELAHIRKAN/NIFAS</h3>
			</center>
			...
			<div class="box box-info">
				...
				<form method="POST" class="form-horizontal" enctype="multipart/form-data" action="<?php echo $aksi; ?>?module=ibubayi&act=update" id="popup-validation">
					<?php
						...
						<div class="col-md-6">
							<div class="box-body">
								...
								<div class="form-group">
									...
									<div class="col-sm-4">
										<input type="text" class="validate[required,custom[date]] form-control" id="tglmelahirkan" name="tglmelahirkan" placeholder="YYYY-MM-DD" value="<?php echo $r[tglmelahirkan]; ?>">
									</div>
								</div>
								...
								<div class="form-group">
									...
									<div class="col-sm-7">
										<input type="text" class="validate[required] form-control" name="kode" id="kode" placeholder="Kode" value="<?php echo $r[kode]; ?>" readonly>
									</div>
								</div>
								<div class="form-group">
						...
						<div class="col-md-6">
							<div class="box-body">
								...
								<div class="form-group">
									...
									<div class="col-sm-7">
										<input type="text" class="validate[required] form-control" name="namabayi" id="namabayi" value="<?php echo $r[namabayi]; ?>" placeholder="Nama Bayi">
									</div>
								</div>
								...
								<div class="form-group">
									...
									<div class="col-sm-7">
										<input type="text" class="form-control" name="namabayik" id="namabayik" placeholder="Nama Bayi/Balita" value="<?php echo $r[namabayik]; ?>">
									</div>
								</div>
								...
								<div class="form-group">
									...
									<div class="col-sm-4">
										<input type="text" class="form-control" id="tglmeninggal" name="tglmeninggal" placeholder="YYYY-MM-DD" value="<?php echo $r[tglmeninggal]; ?>">
									</div>
								</div>
								...
								<div class="form-group">
									...
									<div class="col-sm-7">
										<input type="text" class="form-control" id="sebabmeninggal" name="sebabmeninggal" placeholder="Sebab Meninggal" value="<?php echo $r[sebabmeninggal]; ?>">
									</div>
								</div>
								...
								<div class="form-group">
									...
									<div class="col-sm-7">
										<input type="text" class="form-control" id="keterangan" name="keterangan" placeholder="Keterangan" value="<?php echo $r[keterangan]; ?>">
									</div>
								</div>
								...
								<div class="form-group">
									...
									<div class="col-sm-7">
										<input type="text" class="form-control" name="userentry" id="userentry" value="<?php echo $_SESSION['ses_nama']; ?>">
									</div>
								</div>
								...
								<div class="form-group">
									...
									<div class="col-sm-4">
										<input type="text" class="form-control" name="waktuentry" placeholder="hh:mm:ss" value="<?php echo "$jam_sekarang"; ?>">
									</div>
								</div>
								...
								<div class="form-group">
									...
									<div class="col-sm-7">
										<input type="text" class="form-control" name="level" id="level" value="<?php echo $_SESSION['ses_level']; ?>">
									</div>
								</div>
					...
					<div class="form-group">
						<div class="col-sm-offset-2 col-sm-5">
							<button class="btn bg-purple btn-flat margin" name="cmdeditmelahirkan" title="Edit"><i class="fa fa-pencil"></i>
								Edit
							</button>
