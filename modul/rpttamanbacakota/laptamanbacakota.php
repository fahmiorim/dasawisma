  ...
  $count=pg_num_rows($dswisma);
	...
	<div class='box'>
                <div class='box-header'>
                  <h2 class='box-title'>Laporan Taman Baca PKK Se-kabupaten Batu Bara</h2>";
				...
				<div class="box-body table-responsive no-padding">
                  <table id='example1' class='table table-bordered table-striped'>
							<script type="text/javascript">
								...
								function popup() {
								window.open('modul/rpttamanbacakota/lap_tamanbacakota.php')
								}
							</script>
							...
							<script type="text/javascript">
								var s5_taf_parent = window.location;
								function popup2() {
								window.open('modul/rpttamanbacakota/lap_tamanbacakota2.php')
								}
							</script>
					...
					$dasa =pg_query($koneksi, "select * from tamanbaca order by lingkungan");
