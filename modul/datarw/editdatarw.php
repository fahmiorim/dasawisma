...
?>
     <center><h3 class="box-title">Edit Data RW Kabupaten Batu Bara</h3></center>
   ...
   <form method="POST" class="form-horizontal" enctype="multipart/form-data" action="<?php echo $aksi;?>?module=datarw&act=update"id="popup-validation">
	<?php
				...
				<div class="col-md-6">
					...
					<div class="form-group">
					 ...
					 <div class="form-group">
					  ...
					  <div class="col-sm-7">
                        <input type="text" class="validate[required] form-control" name="nama_datarw" value="<?php echo $r[nama_datarw];?>" placeholder="Nama RW">
                       </div>
					 </div>
