...
if(isset($_POST['chk'])=="")
{
    ...
    <script>
       ...
       window.location.href = 'appmaster.php?module=gotongroyong';
    </script>
    <?php
}
$chk = $_POST['chk'];
...
?>
     <center><h3 class="box-title">LIHAT DATA KEGIATAN WARGA</h3></center>
   ...
   <form method="POST" class="form-horizontal" enctype="multipart/form-data" action="<?php echo $aksi;?>?module=gotongroyong"id="popup-validation">
	<?php
        ...
        <input type="hidden" name="id" value="<?php echo $r['id'];?>" />
				<div class="col-md-6">
				   ...
				   <div class="form-group">	
					  ...
					  <div class="col-sm-7">
                       <select class='validate[required] form-control' name='kegiatan' id='kegiatan'readonly>
				...
				<div class="form-group">
				  ...
				  <div class="form-group">
					<label for="sumberdana" class="col-sm-4 control-label">Jumlah Dana<span class="text-danger"> *</span></label>
					  <div class="col-sm-7">
					    <input type="text" class="validate[required,custom[number]] form-control" name="sumberdana" id="sumberdana" placeholder="Jumlah Dana"value="<?php echo $r[sumberdana];?>"readonly>
                     </div>
				</div>
