...
if (empty($_SESSION['ses_user']) and empty($_SESSION['ses_password'])) {
  ...
  switch ($act) {
    default:
      $sipkunjungan = pg_query($koneksi, "select * from sipkunjungan where tahun='$_SESSION[thnaktif]' and kodekec='$_SESSION[ses_kodekec]' order by tahun desc,nobln");
        ...
        <div style="text-align:right">
          ...
          ?>
            ...
            <div class="form-group">
              <div class="form-group">
                <label for="idposyandu" class="col-sm-1 control-label">ID.Posyandu</label>
                <div class="col-sm-2">
                ...
                </div><button type="button" class="col-sm-1 btn btn-info" data-toggle="modal" data-target="#myModal16"><i class="fa fa-search"></i> Cari</button>
              </div>

              <div class="form-group">
                <label for="posyandu" class="col-sm-1 control-label">Nama Posyandu</label>
                <div class="col-sm-2">
            ...
            <button class="btn bg-blue btn-flat margin" data-toggle="tooltip" data-placement="top" title="Print Tahunan" onClick="print_records_rptsipkunjunganthnkec();"><i class="fa fa-print"></i>Tahunan</button>
        ...
        <div class="box-body table-responsive no-padding">
          <table id='example1' class='table table-bordered table-striped'>
            ...
            <tbody>
              ...
              $tim = pg_query($koneksi, "select * from sipkunjungan where tahun='$_SESSION[thnaktif]' and kodekec='$_SESSION[ses_kodekec]' order by tahun desc,nobln ");
            ...
            <div class="modal-body">
              <table id="example3" class="table table-bordered table-striped">
                ...
                <tbody>
                  ...
                  $qu = pg_query($koneksi, "SELECT * FROM posyandu where kodekec='$_SESSION[ses_kodekec]' order by id desc");
                  while ($data = pg_fetch_array($qu)) {
                  ?>
                    <tr class="pilih16" data-id="<?php echo $data['id']; ?>" data-idposyandu="<?php echo $data['idposyandu']; ?>" data-namaposyandu="<?php echo $data['namaposyandu']; ?>">
