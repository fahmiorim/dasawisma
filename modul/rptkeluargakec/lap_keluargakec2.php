...
$id = $_GET['id'];
$res = pg_query($koneksi, "select * from keluarga where kodekec='$_GET[kdkec]'");
$r = pg_fetch_array($res);

header("Content-Type: application/vnd.ms-excel");
header("Content-Disposition: attachment; filename=Rpt_KeluargaKec.xls");
...
<table width="1016" border="0">
  ...
  <tr>
    <td colspan="4" align="center"><strong>KECAMATAN <?php echo $namakec; ?></strong></td>
  </tr>
  ...
  <tr>
    <td align="center">&nbsp;</td>
    <td align="center">
      <div align="left"><span class="style5">DESA/KELURAHAN</span></div>
    </td>
    <td align="center"><span class="style5">:</span></td>
    <td align="center">&nbsp;</td>
  </tr>
  ...
  <tr>
    <td colspan="4">
      <table width="1304" border="1" cellpadding="0" cellspacing="0" class="table table-bordered table-striped">
        ...
        $no = 1;
        $dasa = pg_query($koneksi, "select * from keluarga where kodekec='$_GET[kdkec]' order by lingkungan ");
