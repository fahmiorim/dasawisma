...
header("Content-Disposition: attachment; filename=Rpt_DasawismaKec.xls");
...
<table width="1974" border="0">
  ...
  <tr>
    <td align="center"><span class="style1">LAPORAN DASAWISMA KECAMATAN <?php echo $namakec ?></span></td>
  </tr>
  ...
  <tr>
    <td>
      <table width="1968" border="1" cellpadding="0" cellspacing="0" class="table table-bordered table-striped">
        ...
        $no = 1;
        $tim = pg_query($koneksi, "select * from dasawisma where kodekec='$_GET[kdkec]' order by lingkungan ");
