		...
		?>
				...
				<div class="box-body table-responsive no-padding">
                  <table id='example1' class='table table-bordered table-striped'>
					...
					$dasa =pg_query($koneksi, "select * from dasawisma where kodekec='".$_SESSION['ses_kodekec']."' order by lingkungan LIMIT $limit OFFSET $offset");
              ...
              ?>
                ...
                <div class='box-footer clearfix'>
                  <ul class='pagination pagination-sm no-margin pull-right'>
                    ...
                    if($page > 1){
                      $prev = $page - 1;
                      echo "<li><a href=\"?module=rptdasawismakec&page=1\">&laquo;</a></li>";
                      echo "<li><a href=\"?module=rptdasawismakec&page=$prev\">&lsaquo;</a></li>";
                    }
                    for($i=$start; $i<=$end; $i++){
                      $aktif = ($i == $page) ? "class=\"active\"" : "";
                      echo "<li $aktif><a href=\"?module=rptdasawismakec&page=$i\">$i</a></li>";
                    }
                    if($page < $total_pages){
                      $next = $page + 1;
                      echo "<li><a href=\"?module=rptdasawismakec&page=$next\">&rsaquo;</a></li>";
                      echo "<li><a href=\"?module=rptdasawismakec&page=$total_pages\">&raquo;</a></li>";
                    }
                    ?>
                  </ul>
