  ...
  $count=pg_num_rows($datawarga);
	...
	<div class='box'>
		...
		?>			
		  ...
		  <button class="btn bg-orange btn-flat margin"  data-toggle="tooltip" data-placement="top" title="Cetak"  onClick="print_records_rptcatkeluargakec();" ><i class="fa fa-print"></i>Cetak</button>
