...
if (empty($_SESSION['ses_user']) AND empty($_SESSION['ses_password'])){  
  ...
  switch($act){
    default:
	 $jlhbalita0106list = pg_query($koneksi, "SELECT * FROM keluarga where kodekel='0106'");
  $count=pg_num_rows($jlhbalita0106list);
	echo"
	...
	<div class='box'>
        ...
        {
		?>			
		   <button class="btn bg-orange btn-flat margin" data-toggle="tooltip" data-placement="top" title="Detail"  onClick="view_records_jlhbalita0106list();" ><i class="fa fa-desktop"></i> Detail</button>
		...
		<?php } ?>	
				...
				<div class="box-body table-responsive no-padding">
                  <table id='example1' class='table table-bordered table-striped'>
					...
					<?php  
					$no = 1;
					$lingk =pg_query($koneksi, "select * from keluarga where kodekel='0106' and balita > 0 order by lingkungan");
