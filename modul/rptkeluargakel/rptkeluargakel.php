		...
		default:
			...
			echo "
                ...
                <div class='box-header'>
                  <h2 class='box-title'>Laporan Data Catatan Keluarga Desa/Kelurahan $namakel</h2>";
?>
			<form method="post" name="frm">
				...
				<div style="text-align:right">
					...
					?>
						...
						<button class="btn bg-purple btn-flat margin" data-toggle="tooltip" data-placement="top" title="Print Per Desa/Kelurahan" onClick="print_records_rptkeluargakel();"><i class="fa fa-print"></i> Print Catatan</button>
