...
if (empty($_SESSION['ses_user']) AND empty($_SESSION['ses_password'])){  
  ...
  switch($act){
    default:
	 $warung = pg_query($koneksi, "select * from warung");
  $count=pg_num_rows($warung);
	echo"
			
				<div class='box'>
                <div class='box-header'>
                  <h2 class='box-title'>Laporan Data Warung PKK</h2>";
                ?>
		 ...
		 <button class="btn bg-purple btn-flat margin"  data-toggle="tooltip" data-placement="top" title="Print"  onClick="print_records_rptwarungkota();" ><i class="fa fa-print"></i> Print Warung PKK</button>
		...
		<?php } ?>	
				...
				<div class="box-body table-responsive no-padding">
                  <table id='example1' class='table table-bordered table-striped'>
					...
					$dasa =pg_query($koneksi, "select * from warung");
