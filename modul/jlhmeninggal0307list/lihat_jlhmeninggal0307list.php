...
if(isset($_POST['chk'])=="")
{
    ...
    <script>
       ...
       window.location.href = 'appmaster.php?module=jlhmeninggal0307list';
    </script>
    <?php
}
$chk = $_POST['chk'];
...
?>
   ...
   <form method="POST" class="form-horizontal" enctype="multipart/form-data" action="<?php echo $aksi;?>?module=jlhmeninggal0307list"id="popup-validation">
	<?php
