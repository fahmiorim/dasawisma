...
?>
     <center><h3 class="box-title">EDIT DATA PEMANFAATAN TANAH PERKARANGAN</h3></center>
   ...
   <form method="POST" class="form-horizontal" enctype="multipart/form-data" action="<?php echo $aksi;?>?module=pekarangan&act=update"id="popup-validation">
	<?php
        ...
        <div class="form-group">
               <div class="col-sm-offset-2 col-sm-5">
                <button class="btn bg-purple btn-flat margin" name="cmdeditpekarangan" title="Edit" ><i class="fa fa-pencil"></i>
                   Edit
                </button>
