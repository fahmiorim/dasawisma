...
?>
     <center><h3 class="box-title">LIHAT DATA IBU HAMIL</h3></center>
   ...
   <form method="POST" class="form-horizontal" enctype="multipart/form-data" action="<?php echo $aksi;?>?module=bumil"id="popup-validation">
	<?php
        ...
        <input type="hidden" name="id" value="<?php echo $r['id'];?>" />
				...
				<div class="col-md-6">
					...
					<label for="Usia Kehamilan" class="col-sm-4 control-label">Usia Kehamilan (bln)<span class="text-danger"> *</span></label>
					  <div class="col-sm-3">
					    <input type="text" class="validate[required,custom[number]] form-control" name="usiahamil" id="usiahamil" value="<?php echo $r[usiahamil];?>"placeholder="Usia Kehamilan" readonly>
                     </div>
					 </div>
