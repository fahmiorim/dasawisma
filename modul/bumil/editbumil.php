...
if(isset($_POST['chk'])=="")
{
    ...
    <script>
       ...
       window.location.href = 'appmaster.php?module=bumil';
    </script>
    <?php
}
$chk = $_POST['chk'];
...
?>
     <center><h3 class="box-title">EDIT DATA IBU HAMIL</h3></center>
   ...
   <form method="POST" class="form-horizontal" enctype="multipart/form-data" action="<?php echo $aksi;?>?module=bumil&act=update"id="popup-validation">
	<?php
		for($i=0; $i<$chkcount; $i++)
		{
			$id = $chk[$i];
			$res=pg_query($koneksi, "select * from bumil where id=".$id);
        ...
        <input type="hidden" name="id" value="<?php echo $r['id'];?>" />
				<div class="col-md-6">
                   ...
                   <div class="form-group">
					...
					<div class="form-group">
					  ...
					  <div class="col-sm-7">
                        <input type="text" class="validate[required] form-control" name="namabumil" id="nama" placeholder="Ibu Hamil"  value="<?php echo $r[namabumil];?>" readonly>
                       </div>
					 </div>
				...
				<div class="col-md-6">
					...
					<label for="Usia Kehamilan" class="col-sm-4 control-label">Usia Kehamilan (bln)<span class="text-danger"> *</span></label>
					  <div class="col-sm-3">
					    <input type="text" class="validate[required,custom[number]] form-control" name="usiahamil" id="usiahamil" value="<?php echo $r[usiahamil];?>"placeholder="Usia Kehamilan">
                     </div>
					 </div>
        ...
        <div class="form-group">
               <div class="col-sm-offset-2 col-sm-5">
                <button class="btn bg-purple btn-flat margin"  name="cmdeditbumil" title="Edit" ><i class="fa fa-pencil"></i>
                   Edit
                </button>
