						...
						<div class="box-body table-responsive no-padding">
							<table id='example1' class='table table-bordered table-striped'>
								<script type="text/javascript">
									...
									function popup() {
										window.open('modul/rptsipkunjungan/rptlap_sipkunjunganthn.php?idposyandu=<?php echo $idpos; ?>')
									}
								</script>
								...
								<script type="text/javascript">
									...
									function popup2() {
										window.open('modul/rptsipkunjungan/rptlap_sipkunjunganthn2.php?idposyandu=<?php echo $idpos; ?>')
									}
								</script>
								...
								<div style="text-align:right">
									<a class="btn bg-green margin" data-toggle="tooltip" data-placement="top" title="Kembali" href="?module=rptsipkunjungan"><i class="fa fa-send"></i> Kembali</a>
								...
								<tbody>
									...
									$tim = pg_query($koneksi, "select * from sipkunjungan where idposyandu='$idpos' and tahun='$_SESSION[thnaktif]' and kodekel='$_SESSION[ses_kodekel]' order by nobln");
